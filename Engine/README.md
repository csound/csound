Engine: internal engine operation
================================

* auxfd.c: auxiliar resource management for opcodes
...
* environ.c: environment variable functions
* extract.c: score extraction
* fgens.c: function table generators
* insert.c: opcode instantiation and insertion
* linevent.c: line event processing
...
* namedins.c: named instrument handling
...
* srconvert.c: sampling rate conversion handling
