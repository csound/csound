...
OENTRY opcodlst_1[] = {
  ...
  { "=.bi",    S(RELAT),0,       "b", "i",
   (SUBR) bassign, NULL, NULL, NULL  },
  { "=.B",    S(RELAT),0,       "B", "b",
    (SUBR) bassign, NULL, NULL, NULL  },
  { "=.Bk",    S(RELAT),0,       "B", "k",
    NULL, (SUBR) bassign, NULL, NULL  },
  ...
  */
  ...
  { "##array_set.S", sizeof(ARRAY_SET), 0, "", "S[].m", (SUBR)array_set ,
    (SUBR)array_set },
  { "##array_set.X", sizeof(ARRAY_SET), 0, "", ".[].m", (SUBR)array_set },
  ...
  { "##array_get.C", sizeof(ARRAY_GET), 0, ":Complex;", ":Complex;[]m", NULL,
    (SUBR)array_get},
  ...
  {"##addin.[i", sizeof(TABARITHIN1), 0, "i[]", "i",
   (SUBR)addinAA, NULL },
  {"##addin.[k", sizeof(TABARITHIN1), 0, "k[]", "i", NULL,
   (SUBR)addinAA },
  ...
  { "release",S(REL),0,           "B",    "",     release_set, (SUBR) release_bool, NULL },
  ...
  */
  ...
  { "active", S(INSTRACT), 0, "b" , ":Instr;", (SUBR) isactive, NULL, NULL },
  { "active", S(INSTRACT), 0, "B" , ":Instr;", NULL, (SUBR) isactive, NULL, },
  { "release", S(INSTRACT), 0, "b",  ":Instr;", (SUBR) isreleasing, NULL, NULL },
  { "release", S(INSTRACT), 0, "B",  ":Instr;", NULL, (SUBR) isreleasing, NULL, },
