...
const OENTRY opcodlst_1[] = {
  ...
  { "getp", S(AOP), 0, ".", ":Opcode;k", (SUBR)get_opcode_output_init,
    (SUBR)get_opcode_output },
  ...
  */
  ...
  { "##array_init", sizeof(ARRAY_SET), 0, "", ".[].m", (SUBR)array_set_init },
  { "##array_set.i", sizeof(ARRAY_SET), 0, "", "i[]im", (SUBR)array_set_init },
  { "##array_set.k", sizeof(ARRAY_SET), 0, "", "k[]km", NULL,(SUBR)array_set},
  { "##array_set.k", sizeof(ARRAY_SET), 0, "", "k[][]km", NULL,(SUBR)array_set},
  { "##array_set.a", sizeof(ARRAY_SET), 0, "", "a[]am", NULL, (SUBR)array_set},
  { "##array_set.S", sizeof(ARRAY_SET), 0, "", "S[]Sm",
    (SUBR)array_set_init, (SUBR)array_set },
  { "##array_set.X", sizeof(ARRAY_SET), 0, "", ".[].m",
    (SUBR)array_set_init, (SUBR)array_set },
  { "##array_set_struct", sizeof(ARRAY_SET), 0, "", ".[].m",
    (SUBR)array_set_struct_i },
  { "##array_set_struct", sizeof(ARRAY_SET), 0, "", ".[].z",
    (SUBR)array_set_struct_init, (SUBR)array_set_struct },
  ...
  { "##array_get.i", sizeof(ARRAY_GET), 0, "i", "i[]m", (SUBR)array_get_init },
  { "##array_get.k", sizeof(ARRAY_GET), 0, "k", "k[]m", (SUBR)array_get_init, (SUBR)array_get },
  { "##array_get.a", sizeof(ARRAY_GET), 0, "a", "a[]m", (SUBR)array_get_init, (SUBR)array_get },
  { "##array_get.S", sizeof(ARRAY_GET), 0, "S", "S[]m", (SUBR)array_get_init, (SUBR)array_get },
  { "##array_geti.S", sizeof(ARRAY_GET), 0, "S", "S[]m", (SUBR)array_get_init},
  { "##array_get.C", sizeof(ARRAY_GET), 0, ":Complex;", ":Complex;[]m", (SUBR)array_get_init,
    (SUBR)array_get},
  { "##array_get.b", sizeof(ARRAY_GET), 0, "b", "b[]m",(SUBR)array_get_init },
  { "##array_get.x", sizeof(ARRAY_GET), 0, ".", ".[]m",(SUBR)array_get_init },
  { "##array_get_init", sizeof(ARRAY_GET), 0, ".", ".[]m",
    (SUBR)array_get_init },
  { "##array_get.K", sizeof(ARRAY_GET), 0, ".", ".[]z",NULL, (SUBR)array_get},
  { "i.Ai", sizeof(ARRAY_GET),0,      "i",    "k[]m", (SUBR)array_get_init  },
  { "i.Ak", sizeof(ARRAY_GET),0,      "i",    "k[]z", (SUBR)array_get_init  },
  ...
  {"##mod.[i]",  sizeof(TABARITH), 0, "i[]", "i[]i[]",
   (SUBR)tabremi},
  {"##mod.[]",  sizeof(TABARITH), 0, "k[]", "k[]k[]",
  ...
  {"##mod.[p",  sizeof(TABARITH1),0,  "i[]", "i[]i",
   (SUBR)tabairemi },
  {"##mod.p[",  sizeof(TABARITH2),0,  "i[]", "ii[]",
   (SUBR)tabiaremi },
  {"##mod.[i",  sizeof(TABARITH1),0,  "k[]", "k[]i",
   (SUBR)tabarithset1, (SUBR)tabairem },
  {"##mod.i[",  sizeof(TABARITH2),0,  "k[]", "ik[]",
   (SUBR)tabarithset2, (SUBR)tabiarem },
  {"##mod.a[k[", sizeof(TABARITH), 0, "a[]", "a[]k[]",
   (SUBR)tabarithset, (SUBR)tabarkrmd },
  {"##mod.k[a[", sizeof(TABARITH), 0, "a[]", "k[]a[]",
  ...
  {"##div.aa[", sizeof(TABARITH2), 0, "a[]", "aa[]",
   (SUBR)tabarithset2, (SUBR)tabaardv },
  {"##mod.[k",  sizeof(TABARITH1),0,  "k[]", "k[]k",
   (SUBR)tabarithset1, (SUBR)tabairem },
  {"##mod.[ak",  sizeof(TABARITH1),0,  "a[]", "a[]k",
   (SUBR)tabarithset1, (SUBR)tabarkrem },
  {"##mod.k[",  sizeof(TABARITH2),0,  "k[]", "kk[]",
   (SUBR)tabarithset2, (SUBR)tabiarem },
  ...
  { "slicearray.k", sizeof(TABSLICE), 0, "k[]", "k[]ijp",
    (SUBR) tabslice, (SUBR) tabslice_perf, NULL },
  { "slicearray.a", sizeof(TABSLICE), 0, "a[]", "a[]ijp",
    (SUBR) tabslice, (SUBR) tabslice_perf, NULL },
  ...
  {"##mulin.Complex[]", sizeof(COPS1), 0, ":Complex;[]",":Complex;[]",
   (SUBR) cops_init, (SUBR) complexa_mulin},
  {"##divin.Complex[]", sizeof(COPS1), 0, ":Complex;[]",":Complex;[]",
   (SUBR) cops_init, (SUBR) complexa_divin},
  {"##addin.Complex[]", sizeof(COPS1), 0, ":Complex;[]",":Complex;[]",
   (SUBR) cops_init, (SUBR) complexa_addin},
  {"##subin.Complex[]", sizeof(COPS1), 0, ":Complex;[]",":Complex;[]",
   (SUBR) cops_init, (SUBR) complexa_subin},
  {"##mulin.Complex[]", sizeof(COPS1), 0, ":Complex;[]","k[]",
   (SUBR) cops_init, (SUBR) complexa_mulrealin},
  {"##divin.Complex[]", sizeof(COPS1), 0, ":Complex;[]","k[]",
   (SUBR) cops_init, (SUBR) complexa_divrealin},
  {"##addin.Complex[]", sizeof(COPS1), 0, ":Complex;[]","k[]",
   (SUBR) cops_init, (SUBR) complexa_addrealin},
  {"##subin.Complex[]", sizeof(COPS1), 0, ":Complex;[]","k[]",
   (SUBR) cops_init, (SUBR) complexa_subrealin},
  {"##add.Complex[]k[]", sizeof(COPS1), 0, ":Complex;[]",
   ":Complex;[]k[]",
   (SUBR) cops_init,(SUBR)complexa_plus_reala},
  {"##mul.Complex[]k[]", sizeof(COPS1), 0, ":Complex;[]",
   ":Complex;[]k[]",
   (SUBR) cops_init,(SUBR)complexa_x_reala},
  {"##sub.Complex[]k[]", sizeof(COPS1), 0, ":Complex;[]",
   ":Complex;[]k[]",
   (SUBR) cops_init,(SUBR)complexa_minus_reala},
  {"##div.Complex[]k[]", sizeof(COPS1), 0, ":Complex;[]",
   ":Complex;[]k[]",
   (SUBR) cops_init,(SUBR)complexa_div_reala},
    {"##add.k[]Complex[]", sizeof(COPS1), 0, ":Complex;[]",
   "k[]:Complex;[]",
   (SUBR) cops_init,(SUBR)reala_plus_complexa},
  {"##mul.k[]Complex[]", sizeof(COPS1), 0, ":Complex;[]",
   "k[]:Complex;[]",
   (SUBR) cops_init,(SUBR)reala_x_complexa},
  {"##sub.k[]Complex[]", sizeof(COPS1), 0, ":Complex;[]",
   "k[]:Complex;[]",
   (SUBR) cops_init,(SUBR)reala_minus_complexa},
  {"##div.k[]Complex[]", sizeof(COPS1), 0, ":Complex;[]",
   "k[]:Complex;[]",
   (SUBR) cops_init,(SUBR)reala_div_complexa},
  {"##mulin.k.Complex", sizeof(CXOP), 0, ":Complex;",":Complex;",
   NULL, (SUBR) complex_mulin},
  {"##divin.k.Complex", sizeof(CXOP), 0, ":Complex;",":Complex;",
   NULL, (SUBR) complex_divin},
  {"##addin.k.Complex", sizeof(CXOP), 0, ":Complex;",":Complex;",
   NULL, (SUBR) complex_addin},
  {"##subin.k.Complex", sizeof(CXOP), 0, ":Complex;",":Complex;",
   NULL, (SUBR) complex_subin},
  ...
  { "memplay",S(DISKIN2_ARRAY),0,  "a[]",
    "SPoooooooo",
    (SUBR) memplay_init_array_S,
    (SUBR) diskin2_perf_array, (SUBR) memplay_deinit_array},
  { "memplay.i",S(DISKIN2_ARRAY),0,  "a[]",
    "iPoooooooo",
    (SUBR) memplay_init_array_I,
    (SUBR) diskin2_perf_array, (SUBR) memplay_deinit_array},
  { "memplay",S(DISKIN2),0,  "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm",
    "SPoooooooo",
    (SUBR) memplay_init_S,
    (SUBR) diskin2_perf, (SUBR) memplay_deinit                           },
  { "memplay.i",S(DISKIN2),0,  "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm",
    "iPoooooooo",
    (SUBR) memplay_init,
    (SUBR) diskin2_perf, (SUBR) memplay_deinit  },
  ...
  { "diskin2.i",S(DISKIN2),0,  "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm",
    ...
    (SUBR) diskin2_init,
    (SUBR) diskin2_perf, (SUBR) diskin2_async_deinit  },
  { "noteon", S(OUT_ON),0,        "",     "iiio",  iout_on, NULL,   NULL    },
  { "noteoff", S(OUT_ON),0,       "",     "iiio",  iout_off, NULL,    NULL  },
  { "noteondur",S(OUT_ON_DUR),0,  "", "iiiio", iout_on_dur_set,iout_on_dur,NULL},
  { "noteondur2",S(OUT_ON_DUR),0, "", "iiiio", iout_on_dur_set,iout_on_dur2,NULL},
  { "moscil",S(MOSCIL),0,         "",     "kkkkko",moscil_set, moscil, NULL},
  { "midion",S(KOUT_ON),0,        "", "kkko", kvar_out_on_set,kvar_out_on,NULL},
  { "outic",S(OUT_CONTR),0,       "",     "iiiiio", out_controller, NULL, NULL},
  { "outkc",S(OUT_CONTR),0,        "",     "kkkkko", NULL, out_controller, NULL},
  { "outic14",S(OUT_CONTR14),0,   "",     "iiiiiio",out_controller14, NULL,NULL},
  { "outkc14",S(OUT_CONTR14),0,    "",     "kkkkkko",NULL, out_controller14, NULL},
  { "outipb",S(OUT_PB),0,         "",     "iiiio", out_pitch_bend, NULL , NULL},
  { "outkpb",S(OUT_PB),0,          "",     "kkkko", NULL,  out_pitch_bend, NULL},
  { "outiat",S(OUT_ATOUCH),0,     "",     "iiiio", out_aftertouch, NULL , NULL},
  { "outkat",S(OUT_ATOUCH),0,      "",     "kkkko", NULL,  out_aftertouch, NULL},
  { "outipc",S(OUT_PCHG),0,       "",     "iiiio", out_progchange, NULL , NULL},
  { "outkpc",S(OUT_PCHG),0,        "",     "kkkko", NULL,  out_progchange, NULL},
  { "outipat",S(OUT_POLYATOUCH),0,"",    "iiiiio", out_poly_aftertouch, NULL,NULL},
  { "outkpat",S(OUT_POLYATOUCH),0, "",    "kkkkko", NULL, out_poly_aftertouch,NULL},
  { "release",S(REL),0,           "k",    "",     release_set, release, NULL },
  { "xtratim",S(XTRADUR),0,       "",     "i",    xtratim,    NULL,     NULL },
  { "mclock", S(MCLOCK),0,        "",     "io",    mclock_set, mclock,   NULL },
  { "mrtmsg", S(XTRADUR),0,       "",     "io",    mrtmsg,     NULL,     NULL },
  { "midiout",S(MIDIOUT),0,        "",     "kkkko", NULL, midiout,   NULL      },
  { "midiout_i",S(MIDIOUT), 0,       "",     "iiiio", midiout,   NULL, NULL     },
  { "midiouti",S(MIDIOUT), 0,       "",     "iiiio", midiout,   NULL, NULL     }, /* Alias */
  { "midion2", S(KON2),0,         "",     "kkkko", kon2_set, kon2,   NULL     },
  { "nrpn",   S(NRPN),0,           "",     "kkko",  NULL,  nrpn ,NULL          },
  { "mdelay", S(MDELAY),0,        "",     "kkkkko",mdelay_set, mdelay,   NULL },
  ...
  */
  ...
  { "adsr", S(ADSR),0,           "k",    "iiiio", adsrset,kadsr, NULL },
  { "adsr.a", S(ADSR),0,         "a",    "iiiio", adsrset,aadsr },
  { "madsr", S(ADSR),0,          "k",    "iiiioj", madsrset,kadsr,NULL },
  { "madsr.a", S(ADSR),0,        "a",    "iiiioj", madsrset,aadsr },
  { "xadsr", S(ADSR),0,          "k",    "iiiio", xdsrset,kadsr,NULL },
  { "xadsr.a", S(ADSR),0,        "a",    "iiiio", xdsrset,aadsr },
  { "mxadsr", S(ADSR),0,         "k",    "iiiioj", mxdsrset,kadsr,NULL },
  { "mxadsr.a", S(ADSR),0,       "a",    "iiiioj", mxdsrset,aadsr },
  ...
  { "miditempo", S(MIDITEMPO),0,  "i",    "o",
    (SUBR) midi_tempo_opcode, NULL, NULL    },
  { "miditempo", S(MIDITEMPO),0,  "k",    "o",
    NULL, (SUBR) midi_tempo_opcode, NULL    },
  { "midifilestatus", S(MIDITEMPO),0,   "k",    "o",
    NULL, (SUBR) midi_file_status, NULL },
  ...
  { "chnget.S[]",    S(CHNGET), _CR,                 "S[]",            "S",
    (SUBR) chnget_opcode_init_ARRAY, (SUBR) notinit_opcode_stub, NULL},
  { "chnget..[]",    S(CHNGET), _CR,                 ".[]",            "S",
    (SUBR) chnget_opcode_init_ARRAY, (SUBR) notinit_opcode_stub, NULL},
  { "chnget.generic",    S(CHNGET),_CR, ".",            "S",
  ...
  { "init.arraycopy", S(ASSIGN), 0, ".[]", ".[]",
    (SUBR)copy_var_generic_init, NULL, NULL},
  ...
  {"lpcfilter", S(LPCFIL), 0,  "a", "akkiiio",
   (SUBR) lpfil_init, (SUBR) lpfil_perf, (SUBR) lpfil_deinit},
  {"lpcfilter", S(LPCFIL2), 0,  "a", "aakkiio",
   (SUBR) lpfil2_init, (SUBR) lpfil2_perf, (SUBR) lpfil2_deinit},
  {"allpole", S(LPCFIL3), 0,  "a", "ak[]",
   (SUBR) lpfil3_init, (SUBR) lpfil3_perf},
  {"lpcanal", S(LPREDA), 0,  "k[]kkk", "kkiiio",
   (SUBR) lpred_alloc, (SUBR) lpred_run, (SUBR) lpred_deinit},
  {"lpcanal", S(LPREDA2), 0,  "k[]kkk", "akkiio",
   (SUBR) lpred_alloc2, (SUBR) lpred_run2, (SUBR) lpred2_deinit},
  {"lpcanal", S(LPREDA), 0,  "i[]iii", "iiiiio",
   (SUBR) lpred_i, NULL, (SUBR) lpred_deinit},
  {"pvslpc", S(LPCPVS), 0,  "f", "aiiio",
   (SUBR) lpcpvs_init, (SUBR) lpcpvs, (SUBR) lpcpvs_deinit},
  {"pvscfs", S(PVSCFS), 0,  "k[]kk", "fip",
   (SUBR) pvscoefs_init, (SUBR) pvscoefs, (SUBR) pvscoefs_deinit},
  {"apoleparams", S(CF2P), 0,  "k[]", "k[]",
   (SUBR) coef2parm_init, (SUBR) coef2parm, (SUBR) coef2parm_deinit},
  ...
  { "midifileloop", S(MIDITEMPO), 0, "", "io", (SUBR) midi_file_loop},
  { "midifileloop", S(MIDITEMPO), 0, "", "kO", NULL, (SUBR) midi_file_loop},
