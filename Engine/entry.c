...
const OENTRY opcodlst_1[] = {
  ...
  */
  ...
  {"##add.aa[", sizeof(TABARITH2), 0, "a[]", "aa[]",
   (SUBR)tabarithset2, (SUBR)tabaardd },
  {"##add.a[a", sizeof(TABARITH1), 0, "a[]", "a[]a",
   (SUBR)tabarithset1, (SUBR)tabaradd },
  ...
  {"##sub.aa[", sizeof(TABARITH2), 0, "a[]", "aa[]",
   (SUBR)tabarithset2, (SUBR)tabaarsb },
  {"##sub.a[a", sizeof(TABARITH1), 0, "a[]", "a[]a",
