...
const OENTRY opcodlst_1[] = {
  ...
  { "init", S(AOP),0,  ":Opcode;", ":OpcodeDef;o", (SUBR) create_opcode_simple},
  { "create", S(OPARRAY),0,  ":Opcode;[]", ":OpcodeDef;io", (SUBR) create_opcode_array},
  { "init", S(OPARRAY),0,  ":Opcode;[]", ":OpcodeDef;io", (SUBR) create_opcode_array},
  ...
  */
  ...
  { "init", S(CREATE_INSTANCE), 0,  ":Instr;", ":InstrDef;", (SUBR) create_instance_opcode, NULL, NULL },
  ...
  { "init",  S(CINSTR), 0,  ":InstrDef;", "S",  (SUBR) compile_instr, NULL, NULL },
