...
const OENTRY opcodlst_1[] = {
  ...
  */
  ...
  {"##mulin.i.Complex", sizeof(CXOP), 0, ":Complex;",":Complex;",
   (SUBR) complex_mulin, NULL},
  {"##mulin.k.Complex", sizeof(CXOP), 0, ":Complex;",":Complex;",
   NULL, (SUBR) complex_mulin},
  {"##divin.i.Complex", sizeof(CXOP), 0, ":Complex;",":Complex;",
   (SUBR) complex_divin, NULL},
  {"##divin.k.Complex", sizeof(CXOP), 0, ":Complex;",":Complex;",
   NULL, (SUBR) complex_divin},
  {"##addin.i.Complex", sizeof(CXOP), 0, ":Complex;",":Complex;",
   (SUBR) complex_addin, NULL},
  {"##addin.k.Complex", sizeof(CXOP), 0, ":Complex;",":Complex;",
   NULL, (SUBR) complex_addin},
  {"##subin.i.Complex", sizeof(CXOP), 0, ":Complex;",":Complex;",
   (SUBR) complex_subin, NULL},
