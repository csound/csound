...
const OENTRY opcodlst_1[] = {
  ...
  */
  ...
  { "memin",S(DISKIN2_ARRAY),0,  "a[]",
    "SPoooooooo",
    (SUBR) memin_init_array_S,
    (SUBR) diskin2_perf_array, (SUBR) memin_deinit_array},
  { "memin.i",S(DISKIN2_ARRAY),0,  "a[]",
    "iPoooooooo",
    (SUBR) memin_init_array_I,
    (SUBR) diskin2_perf_array, (SUBR) memin_deinit_array},
  { "memin",S(DISKIN2),0,  "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm",
    "SPoooooooo",
    (SUBR) memin_init_S,
    (SUBR) diskin2_perf, (SUBR) memin_deinit                           },
  { "memin.i",S(DISKIN2),0,  "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm",
    "iPoooooooo",
    (SUBR) memin_init,
    (SUBR) diskin2_perf, (SUBR) memin_deinit  },
