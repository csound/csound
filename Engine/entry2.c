...
{ "alpass", S(COMB),    5,  "a",  "akioo", (SUBR)cmbset,NULL,   (SUBR)alpass  },
 ...
 { "loop_lt.k", S(LOOP_OPS), 1,  "", "kkkl", NULL, (SUBR) loop_l_p, NULL   },
 { "loop_le.k", S(LOOP_OPS), 1,  "", "kkkl", NULL, (SUBR) loop_le_p, NULL  },
 { "loop_gt.k", S(LOOP_OPS), 1,  "", "kkkl", NULL, (SUBR) loop_g_p, NULL   },
 { "loop_ge.k", S(LOOP_OPS), 1,  "", "kkkl", NULL, (SUBR) loop_ge_p, NULL  },
 {  "chnget",   0xFFFF,      0,NULL, NULL, (SUBR)NULL, (SUBR)NULL, (SUBR)NULL },
