...
{ "zakinit", ZB|S(ZAKINIT), 1,  "",   "ii",   (SUBR)zakinit, NULL,  NULL},
{ "zir",    ZR|S(ZKR),  1,   "i",  "i",    (SUBR)zir,     NULL,  NULL},
{ "zkr",    ZR|S(ZKR),  3,   "k",  "k",    (SUBR)zkset,   (SUBR)zkr,   NULL},
{ "ziw",    ZW|S(ZKW),  1,   "",   "ii",   (SUBR)ziw,     NULL,  NULL},
{ "zkw",    ZW|S(ZKW),  3,   "",   "kk",   (SUBR)zkset,   (SUBR)zkw,   NULL},
{ "ziwm",   ZW|S(ZKWM), 1,   "",   "iip",  (SUBR)ziwm,    NULL,  NULL},
{ "zkwm",   ZW|S(ZKWM), 3,   "",   "kkp",  (SUBR)zkset,   (SUBR)zkwm,  NULL},
{ "zkmod",  ZB|S(ZKMOD),2,   "k",  "kk",   NULL,    (SUBR)zkmod, NULL},
{ "zkcl",   ZW|S(ZKCL), 3,   "",  "kk",   (SUBR)zkset,   (SUBR)zkcl,  NULL},
{ "zar",    ZR|S(ZAR),  5,   "a", "k",    (SUBR)zaset,   NULL,  (SUBR)zar},
{ "zarg",   ZB|S(ZARG), 5,   "a", "kk",   (SUBR)zaset,   NULL,  (SUBR)zarg},
{ "zaw",    ZW|S(ZAW),  5,   "",  "ak",   (SUBR)zaset,   NULL,  (SUBR)zaw},
{ "zawm",   ZB|S(ZAWM), 5,   "",  "akp",  (SUBR)zaset,   NULL,  (SUBR)zawm},
{ "zamod",  ZB|S(ZAMOD),4,   "a", "ak",   NULL,    NULL,  (SUBR)zamod},
{ "zacl",   ZW|S(ZACL), 5,   "",  "kk",   (SUBR)zaset,   NULL,  (SUBR)zacl},
{ "inz",    ZW|S(IOZ),  4,   "",   "k",    (SUBR)zaset,  NULL,   (SUBR)inz  },
{ "outz",   ZR|S(IOZ),  4,   "",   "k",    (SUBR)zaset,  NULL,   (SUBR)outz },
