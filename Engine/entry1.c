...
OENTRY opcodlst_1[] = {
  ...
  */
  ...
  //{ "invalue",   0xFFFF,   _CS_CR,    0,   NULL,   NULL, NULL, NULL },
  { "invalue.k", S(INVAL),_CS_CR, 3, "k", "i", (SUBR) invalset,(SUBR)kinval, NULL },
  { "invalue.i", S(INVAL),_CS_CR, 1, "i", "i", (SUBR) invalsetgo, NULL, NULL },
  { "invalue.iS", S(INVAL),_CS_CR, 1, "i", "S", (SUBR) invalsetSgo, NULL, NULL },
  { "invalue.kS", S(INVAL),_CS_CR, 3, "k", "S",(SUBR) invalset_S,(SUBR)kinval, NULL },
  { "invalue.S", S(INVAL),_CS_CR, 3, "S", "i",
                                      (SUBR) invalset_string, (SUBR)kinvalS, NULL },
  { "invalue.SS", S(INVAL),_CS_CR, 3, "S", "S",
  ...
  */
  ...
  //{ "chani",      0xFFFF,  _CS_CR,      0,   NULL, NULL, NULL, NULL },
  { "chani.k",     S(ASSIGN),_CS_CR,           2,      "k",            "k",
    NULL, (SUBR) chani_opcode_perf_k, NULL                },
  { "chani.a",     S(ASSIGN),_CS_CR,           2,      "a",            "k",
