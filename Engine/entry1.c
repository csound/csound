...
{ "soundout",S(SNDOUT), QQ|5,   "",     "aTo",  sndo1set, NULL, soundout  },
{ "soundouts",S(SNDOUTS),QQ|5,  "",     "aaTo", sndo1set, NULL, soundouts },
...
{ "diskin",S(SOUNDINEW),QQ|5, "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm",
                            "Tkooooo",
