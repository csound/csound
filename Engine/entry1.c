...
{ "table.k",  S(TABL), 3,      "k",    "xiooo",(SUBR)tabl_setup, 
                                               (SUBR)tabler_kontrol     },
{ "table.a",  S(TABL), 5,      "a",    "xiooo",(SUBR)tabl_setup, NULL, 
                                               (SUBR)tabler_audio       },
{ "tablei.i", S(TABL), 1,      "i",    "iiooo",(SUBR)tableir_init       },
{ "tablei.k", S(TABL), 3,      "k",    "xiooo",(SUBR)tabl_setup, 
                                               (SUBR)tableir_kontrol    },
{ "tablei.a", S(TABL), 5,      "a",    "xiooo",(SUBR)tabl_setup, NULL,
                                               (SUBR)tableir_audio      },
{ "table3.i", S(TABL), 1,      "i",    "iiooo",(SUBR)table3r_init       },
{ "table3.k", S(TABL), 3,      "k",    "xiooo",(SUBR)tabl_setup, 
                                               (SUBR)table3r_kontrol    },
{ "table3.a", S(TABL), 5,      "a",    "xiooo",(SUBR)tabl_setup, NULL, 
                                               (SUBR)table3r_audio      },
{ "ptable",  0xffff, TR                                                 },
{ "ptablei", 0xffff, TR                                                 },
{ "ptable3", 0xffff, TR                                                 },
...
{ "tablew.kk", S(TABL),  3,    "", "kkiooo",(SUBR)tabl_setup,
                                            (SUBR)tablew_kontrol, NULL          },
{ "tablew.aa", S(TABL),  5,    "", "aaiooo",(SUBR)tabl_setup, NULL, 
                                            (SUBR)tablew_audio               },
...
{ "printk", S(PRINTK),  3|WR,"",   "iko",  (SUBR)printkset, (SUBR)printk, NULL },
{ "printks",S(PRINTKS), 3|WR,   "",   "TiM",  (SUBR)printksset,(SUBR)printks, NULL },
{ "prints",S(PRINTS),   1,   "",   "TM",   (SUBR)printsset, NULL, NULL },
{ "printk2", S(PRINTK2),3|WR, "",   "ko",   (SUBR)printk2set, (SUBR)printk2, NULL },
...
{ "schedule", S(SCHED),  1,     "",     "Tiim", schedule, /*schedwatch */ NULL, NULL },
...
{ "nreverb",  S(NREV2),  5,     "a",    "akkoojoj",
                                         (SUBR)reverbx_set,NULL,(SUBR) reverbx },
{ "=.f",      S(FASSIGN), 3,    "f",   "f",      (SUBR)fassign_set, (SUBR)fassign },
...
{ "vdelayxws",S(VDELXS),5,  "aa", "aaaiio", (SUBR)vdelxsset, NULL, 
                                            (SUBR)vdelayxws                  },
