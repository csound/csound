...
OENTRY opcodlst_1[] = {
  ...
  { "ctrlinit",S(CTLINIT),0,1,      "",     "im", ctrlinit, NULL, NULL, NULL, 0 },
   { "massign",S(MASSIGN), 0,1,      "",     "iip",massign_p, NULL, NULL, NULL, 0 },
  { "massign.iS",S(MASSIGNS), 0,1,      "",     "iSp",massign_S, NULL, NULL, NULL, 0 },
  { "turnon", S(TURNON),  0,1,      "",     "io", turnon, NULL, NULL, NULL, 0 },
  { "turnon.S", S(TURNON),  0,1,      "",     "So", turnon_S, NULL, NULL, NULL, 0 },
  ...
  */
  ...
  { "schedkwhen.S", S(TRIGINSTR),0, 3,"",     "kkkSkz",triginset_S, ktriginstr_S, NULL },
  { "schedkwhennamed", S(TRIGINSTR),0, 3,"", "kkkkkz",triginset, ktriginstr, NULL },
  { "schedkwhennamed.S", S(TRIGINSTR),0, 3,"", "kkkSkz",triginset_S, ktriginstr_S, NULL },
  ...
  { "invalue.S", S(INVAL),0, 3, "S", "i",   (SUBR) invalset_string, (SUBR) kinval, NULL },
  { "invalue.SS", S(INVAL),0, 3, "S", "S",   (SUBR) invalset_string_S, (SUBR) kinval, NULL },
  { "outvalue", S(OUTVAL), CW, 3, "", "ik",(SUBR) outvalset, (SUBR) koutval, NULL},
  { "outvalue.k", S(OUTVAL), CW, 3, "", "Sk",(SUBR) outvalset_S, (SUBR) koutval, NULL},
  { "outvalue.S", S(OUTVAL), CW, 3, "", "iS",(SUBR) outvalset_string, (SUBR) koutval, NULL},
  { "outvalue.SS", S(OUTVAL), CW, 3, "", "SS",(SUBR) outvalset_string_S, (SUBR) koutval, NULL},
  /* IV - Oct 20 2002 */
