...
/* opcode   dspace      thread  outarg  inargs  isub    ksub    asub    */
  ...
  { "instr",  0,          0,      "",     "",   NULL, NULL, NULL, NULL, 0 },
  { "endin",  0,          0,      "",     "",   NULL, NULL, NULL, NULL, 0 },
/* IV - Sep 8 2002 */
  { "opcode", 0,          0,      "",     "",   NULL, NULL, NULL, NULL, 0 },
  { "endop",  0,          0,      "",     "",   NULL, NULL, NULL, NULL, 0 },
  { "$label", S(LBLBLK),  0,      "",     "",   NULL, NULL, NULL, NULL, 0 },
  { "pset",   S(PVSET),   0,      "",     "m",  NULL, NULL, NULL, NULL, 0 },
  { "ctrlinit",S(CTLINIT),1,      "",     "im",   ctrlinit, NULL, NULL, NULL, 0 },
  { "massign",S(MASSIGN), 1,      "",     "iTp",  massign, NULL, NULL, NULL, 0 },
  { "turnon", S(TURNON),  1,      "",     "To",   turnon, NULL, NULL, NULL, 0 },
  { "remoteport", S(REMOTEPORT), 1, "",   "i",    remoteport, NULL, NULL, NULL, 0 },
  { "insremot",S(INSREMOT),1,     "",     "SSm",  insremot, NULL, NULL, NULL, 0 },
  { "midremot",S(MIDREMOT),1,     "",     "SSm",  midremot, NULL, NULL, NULL, 0 },
  { "insglobal",S(INSGLOBAL),1,   "",     "Sm",   insglobal, NULL, NULL, NULL, 0 },
  { "midglobal",S(MIDGLOBAL),1,   "",     "Sm",   midglobal, NULL, NULL, NULL, 0 },
  { "=",      0,          0,      "",     "",   NULL, NULL, NULL, NULL, 0 },
  { "init",   0xffff      /* base names for later prefixes,suffixes */    },
{ "betarand",0xffff,      0,      "",     "",   NULL, NULL, NULL, NULL, 0 },
{ "bexprnd", 0xffff                                                     },
{ "cauchy",  0xffff                                                     },
{ "cauchyi", 0xffff                                                     },
{ "chanctrl",0xffff                                                     },
...
{ "log2.k", S(EVAL),    2,      "k",    "k",    NULL,   log21           },
...
{ "log2.a", S(EVAL),    4,      "a",    "a",    NULL,   NULL,   log2a   },
...
{ "cosseg", S(COSSEG),  7,      "s",    "iin",  csgset, kosseg, cosseg  },
{ "cossegb", S(COSSEG), 7,      "s",    "iin",  csgset_bkpt, kosseg, cosseg  },
{ "cossegr", S(COSSEG),  7,     "s",    "iin",  csgrset, kcssegr, cossegr  },
...
{ "tablei", 0xffff, TR                                                  },
{ "table3", 0xffff, TR                                                  },
{ "table.i",  S(TABL), 1,      "i",    "iiooo",(SUBR)tabler_init             },
{ "table.k",  S(TABL), 3,      "k",    "xiooo",(SUBR)tabl_setup,(SUBR)tabler_kontrol},
{ "table.a",  S(TABL), 5,      "a",    "xiooo",(SUBR)tabl_setup, NULL, (SUBR)tabler_audio},
{ "tablei.i", S(TABL), 1,      "i",    "iiooo",(SUBR) tableir_init                },
{ "tablei.k", S(TABL), 3,      "k",    "xiooo",(SUBR)tabl_setup, (SUBR)tableir_kontrol},
{ "tablei.a", S(TABL), 5,      "a",    "xiooo",(SUBR)tabl_setup, NULL, (SUBR)tableir_audio},
{ "table3.i", S(TABL), 1,      "i",    "iiooo",(SUBR)table3r_init                  },
{ "table3.k", S(TABL), 3,      "k",    "xiooo",(SUBR)tabl_setup, (SUBR)table3r_kontrol},
{ "table3.a", S(TABL), 5,      "a",    "xiooo",(SUBR)tabl_setup, NULL, (SUBR)table3r_audio},
{ "ptable",  0xffff, TR                                                 },
{ "ptablei", 0xffff, TR                                                 },
{ "ptable3", 0xffff, TR                                                 },
...
{ "diskin",S(DISKIN2), 5, "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm",
                            "Tkooooooo",
...
{ "tablew.kk", S(TABL),  3,    "", "kkiooo",(SUBR)tabl_setup,(SUBR)tablew_kontrol, NULL},
{ "tablew.aa", S(TABL),  5,    "", "aaiooo",(SUBR)tabl_setup, NULL, (SUBR)tablew_audio},
{ "tablewkt.kk", S(TABL),3, "",  "kkkooo",
                          (SUBR)tablkt_setup,(SUBR)tablewkt_kontrol,NULL},
{ "tablewkt.aa", S(TABL),5, "",  "aakooo",
                          (SUBR)tablkt_setup,NULL,(SUBR)tablewkt_audio},
{ "tableng.i", S(TLEN),1,  "i",     "i",    (SUBR)table_length, NULL,  NULL},
{ "tableng.k",  S(TLEN),2, "k",     "k",    NULL,   (SUBR)table_length, NULL},
{ "tableigpw",S(TGP),TB|1,   "",  "i",    (SUBR)table_gpw, NULL,  NULL},
{ "tablegpw", S(TGP),2,   "",  "k",    NULL,   (SUBR)table_gpw, NULL},
...
{ "tablekt",  S(TABL), TR|7,     "s",  "xkooo",tablkt_setup,  tablerkt_kontrol, tablerkt_audio },
{ "tableikt", S(TABL), TR|7,     "s",  "xkooo",tablkt_setup,  tableirkt_kontrol,  tableirkt_audio },
{ "table3kt", S(TABL), TR|7,     "s",  "xkooo",tablkt_setup,  table3rkt_kontrol,  table3rkt_audio },
...
{ "nreverb",  S(NREV2),  5,     "a",    "akkoojoj",
                                         (SUBR)reverbx_set,NULL,(SUBR) reverbx },
{ "=.f",      S(FASSIGN), 3,    "f",   "f",      fassign_set, fassign, NULL    },
{ "init.f",   S(FASSIGN), 1,    "f",   "f",      fassign_set, NULL, NULL    },
