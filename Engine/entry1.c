...
{ "soundout",S(SNDOUT), _DP_|5,   "",     "aTo",  sndo1set, NULL, soundout  },
{ "soundouts",S(SNDOUTS),_DP_|5,  "",     "aaTo", sndo1set, NULL, soundouts },
...
{ "diskin",S(SOUNDINEW),_DP_|5, "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm",
                            "Tkooooo",
