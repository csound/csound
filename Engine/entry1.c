...
OENTRY opcodlst_1[] = {
  ...
  */
  ...
  { "invalue.i", S(INVAL),0, 3, "i", "i",   (SUBR) invalsetgo, NULL, NULL },
  { "invalue.kS", S(INVAL),0, 3, "k", "S", (SUBR) invalset_S,(SUBR)  kinval, NULL },
  { "invalue.iS", S(INVAL),0, 3, "i", "S", (SUBR) invalsetSgo, NULL, NULL },
  ...
  { "outvalue.i", S(OUTVAL), CW, 3, "", "ii", (SUBR) outvalsetgo, NULL, NULL},
  { "outvalue.k", S(OUTVAL), CW, 3, "", "Sk",
                                          (SUBR) outvalset_S, (SUBR) koutval, NULL},
  { "outvalue.Si", S(OUTVAL), CW, 3, "", "Si",
