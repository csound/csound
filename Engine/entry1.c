...
OENTRY opcodlst_1[] = {
  ...
  { "oscil.a",S(OSC),TR,    5,       "a",    "kkjo", oscset, NULL,   osckk  },
  { "oscil.kkk",S(OSC),TR,   3,      "k",    "kkjo", oscset, koscil  },
  { "oscil.kka",S(OSC),TR,   5,      "a",    "kkjo", oscset, NULL, osckk  },
  { "oscil.ka",S(OSC),TR,    5,      "a",    "kajo", oscset, NULL,   oscka  },
  { "oscil.ak",S(OSC),TR,    5,      "a",    "akjo", oscset, NULL,   oscak  },
  { "oscil.aa",S(OSC),TR,    5,      "a",    "aajo", oscset, NULL,   oscaa  },
  { "oscil.kkA",S(OSC),0,   3,      "k",    "kki[]o", oscsetA, koscil       },
  { "oscil.kkA",S(OSC),0,   5,      "a",    "kki[]o", oscsetA, NULL, osckk },
  ...
  /* Change these to
     ...
     { "oscil.kka", S(POSC),TR, 5,, "a", "kkjo", posc_set, NULL, posckk },
     { "oscil.ka", S(POSC),TR, 5, "a", "kajo", posc_set, NULL,  poscka },
     { "oscil.ak", S(POSC),TR, 5, "a", "akjo", posc_set, NULL,  poscak },
     { "oscil.aa", S(POSC),TR, 5, "a", "aajo", posc_set, NULL,  poscaa },
     { "oscil3.kk",  S(POSC),TR,  7, "s", "kkjo", posc_set, kposc3, posc3 },
  */
  { "oscili.a",S(OSC),TR,   5,      "a",    "kkjo", oscset, NULL, osckki  },
  { "oscili.kk",S(OSC),TR,   3,      "k",   "kkjo", oscset, koscli, NULL  },
  { "oscili.ka",S(OSC),TR,   5,      "a",   "kajo", oscset, NULL,   osckai  },
  { "oscili.ak",S(OSC),TR,   5,      "a",   "akjo", oscset, NULL,   oscaki  },
  { "oscili.aa",S(OSC),TR,   5,      "a",   "aajo", oscset, NULL,   oscaai  },
  ...
  { "oscil3.a",S(OSC),TR,   5,      "a",    "kkjo", oscset, NULL, osckk3  },
  { "oscil3.kk",S(OSC),TR,   3,      "k",   "kkjo", oscset, koscl3, NULL  },
  { "oscil3.ka",S(OSC),TR,   5,      "a",   "kajo", oscset, NULL,   oscka3  },
  { "oscil3.ak",S(OSC),TR,   5,      "a",   "akjo", oscset, NULL,   oscak3  },
  { "oscil3.aa",S(OSC),TR,   5,      "a",   "aajo", oscset, NULL,   oscaa3  },
  ...
  */
  ...
  { "madsr.a", S(LINSEG),0,    5,     "a",    "iiiioj", madsrset,NULL, linsegr },
