...
{ "tablewkt",0xfffe, TW                                                 },
  ...
  { "=.a",    S(ASSIGN),0,  4,      "a",    "x",    NULL,   NULL,   aassign },
  ...
  { ">",      S(RELAT),0,   0,      "B",    "kk",   gt,     gt              },
  { ">=",     S(RELAT),0,   0,      "B",    "kk",   ge,     ge              },
  { "<",      S(RELAT),0,   0,      "B",    "kk",   lt,     lt              },
  { "<=",     S(RELAT),0,   0,      "B",    "kk",   le,     le              },
  { "==",     S(RELAT),0,   0,      "B",    "kk",   eq,     eq              },
  { "!=",     S(RELAT),0,   0,      "B",    "kk",   ne,     ne              },
  { "&&",     S(LOGCL),0,   0,      "B",    "BB",   and,    and             },
  { "||",     S(LOGCL),0,   0,      "B",    "BB",   or,     or              },
  { ":i",     S(CONVAL),0,  1,      "i",    "bii",  conval                  },
  { ":k",     S(CONVAL),0,  2,      "k",    "Bkk",  NULL,   conval          },
  { ":a",     S(CONVAL),0,  4,      "a",    "Bxx",  NULL,   NULL,   aconval },
...
{ "ptable3", 0xffff, TR                                                 },
  ...
  { "oscil.kk",S(OSC),0,    7,      "s",    "kkio", oscset, koscil, osckk   },
  { "oscil.ka",S(OSC),0,    5,      "a",    "kaio", oscset, NULL,   oscka   },
  { "oscil.ak",S(OSC),0,    5,      "a",    "akio", oscset, NULL,   oscak   },
  { "oscil.aa",S(OSC),0,    5,      "a",    "aaio", oscset, NULL,   oscaa   },
/* CHangerthese to
{ "oscil.kk", S(POSC),0, 7, "s", "kkio", posc_set, kposc, posckk },
{ "oscil.ka", S(POSC),0, 5, "a", "kaio", posc_set, NULL,  poscka },
{ "oscil.ak", S(POSC),0, 5, "a", "akio", posc_set, NULL,  poscak },
{ "oscil.aa", S(POSC),0, 5, "a", "aaio", posc_set, NULL,  poscaa },
{ "oscil3.kk",  S(POSC),0,  7, "s", "kkio", posc_set, kposc3, posc3 },
*/
  { "oscili.kk",S(OSC),0,   7,      "s",    "kkio", oscset, koscli, osckki  },
  { "oscili.ka",S(OSC),0,   5,      "a",    "kaio", oscset, NULL,   osckai  },
  { "oscili.ak",S(OSC),0,   5,      "a",    "akio", oscset, NULL,   oscaki  },
  { "oscili.aa",S(OSC),0,   5,      "a",    "aaio", oscset, NULL,   oscaai  },
  { "oscil3.kk",S(OSC),0,   7,      "s",    "kkio", oscset, koscl3, osckk3  },
  { "oscil3.ka",S(OSC),0,   5,      "a",    "kaio", oscset, NULL,   oscka3  },
  { "oscil3.ak",S(OSC),0,   5,      "a",    "akio", oscset, NULL,   oscak3  },
  { "oscil3.aa",S(OSC),0,   5,      "a",    "aaio", oscset, NULL,   oscaa3  },
/* end change */
  ...
  { "adsyn",  S(ADSYN),0,   5,      "a",    "kkkTo", adset, NULL,   adsyn   },
  ...
  { "atone",  S(TONE),0,    5,      "a",    "ako",  tonset, NULL,   atone   },
  ...
  { "lpread", S(LPREAD),0,  3,      "kkkk", "kToo", lprdset,lpread          },
...
/* { "outq",   S(OUTQ),0,    4,      "",     "aaaa", NULL,   NULL,   outq    }, */
  ...
  { "cggoto", S(CGOTO),0,   3,      "",     "Bl",   icgoto, kcgoto          },
  ...
  { "display",S(DSPLAY),0,  7,      "",     "sioo", dspset, kdsplay,dsplay  },
  { "pvsdisp",S(FSIGDISP),0,  3,      "",     "foo", fdspset, fdsplay,NULL },
  { "dispfft",S(DSPFFT),0,  7,      "",     "siiooo",fftset,kdspfft,dspfft  },
  { "dumpk",  S(KDUMP),0,   3,      "",     "kTii", kdmpset,kdump           },
  { "dumpk2", S(KDUMP2),0,  3,      "",     "kkTii",kdmp2set,kdump2         },
  { "dumpk3", S(KDUMP3),0,  3,      "",     "kkkTii",kdmp3set,kdump3        },
  { "dumpk4", S(KDUMP4),0,  3,      "",     "kkkkTii",kdmp4set,kdump4       },
  { "readk",  S(KREAD),0,   3,      "k",    "Tii",   krdset, kread          },
  { "readk2", S(KREAD2),0,  3,      "kk",   "Tii",   krd2set, kread2        },
  ...
  { "xyin",     S(XYIN),0,    3,    "kk",   "iiiiioo",xyinset,xyin          },
  ...
  { "logbtwo.a",S(EVAL),0,   5,     "a",    "a", logbasetwo_set, NULL, logbasetwoa },
...
/*  { "nlalp", S(NLALP),0,     5,     "a",    "akkoo", nlalp_set, NULL, nlalp }, */
  ...
  { "ptablew.kk", S(TABLEW),0,  3,  "", "kkiooo",(SUBR)itblchkw,(SUBR)pktablew, NULL},
  { "ptablew.aa", S(TABLEW),0,  5,  "", "aaiooo",(SUBR)itblchkw, NULL, (SUBR)ptablew},
  ...
  { "timeinstk", S(RDTIME),0, 3, "k",  "",     (SUBR)instimset, (SUBR)instimek, NULL },
  { "timeinsts", S(RDTIME),0, 3, "k",  "",     (SUBR)instimset, (SUBR)instimes, NULL },
  { "peak.k",  S(PEAK),0,   2,   "k",  "k",    NULL,    (SUBR)peakk,    NULL },
  { "peak.a",   S(PEAK),0,  4,   "k",  "a",    NULL,    NULL,     (SUBR)peaka },
  { "printk", S(PRINTK),WR,  3,"",   "iko",  (SUBR)printkset, (SUBR)printk, NULL },
  { "printks",S(PRINTKS),WR, 3,   "",   "TiM",  (SUBR)printksset,(SUBR)printks, NULL },
  { "prints",S(PRINTS),0,   1,   "",   "TM",   (SUBR)printsset, NULL, NULL },
  { "printk2", S(PRINTK2),WR, 3, "",   "ko",   (SUBR)printk2set, (SUBR)printk2, NULL },
...
/* opcode   dspace      thread  outarg  inargs  isub    ksub    asub    */
  ...
  { "in32",   S(INALL),0,   4,      "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
                                        "",     NULL,   NULL,   in32 },
//{ "inch",   S(INCH),0,    4,      "a",    "k",    NULL,   NULL,   inch_opcode },
  ...
  /* Note that there is code in rdorch.c that assumes that opcodes starting
     ...
     ***BEWARE***
     CODE REMOVED 2011-Dec-14
   */
/* { "outh",   S(OUTH),0,    4,      "",     "aaaaaa",NULL,  NULL,   outh    }, */
/* { "outo",   S(OUTO),0,    4,      "",     "aaaaaaaa",NULL,NULL,   outo    }, */
/* { "outx",   S(OUTX),0,    4,      "",     "aaaaaaaaaaaaaaaa",NULL,NULL, outx }, */
/* { "out32",  S(OUTX),0,    4,      "",     "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", */
                                                /* NULL,   NULL,   outX    }, */
  ...
  { "schedule", S(SCHED),0,  1,     "",     "Tiim", schedule, /*schedwatch */ NULL, NULL },
  ...
  { "pvsanal",  S(PVSANAL),0, 5,    "f",   "aiiiioo",  pvsanalset, NULL, pvsanal   },
  ...
  { "pvsfread", S(PVSFREAD),0,3,    "f",   "kTo",    pvsfreadset, pvsfread, NULL  },
...
{ "db",       0xffff                                                    },
  ...
  { "pgmassign",S(PGMASSIGN),0, 1,  "",     "iTo",   pgmassign, NULL, NULL  },
  ...
  { "midipitchbend", S(MIDIPITCHBEND),0,3, "", "xoh", midipitchbend, midipitchbend },
...
/* IV - Sep 5 2002 */
  ...
  { "integ", S(INDIFF),0, 7, "s", "xo", (SUBR)indfset,(SUBR)kntegrate,(SUBR)integrate},
  ...
  { "vdelayxws",S(VDELXS),0,5,  "aa", "aaaiio", (SUBR)vdelxsset, NULL, 
                                            (SUBR)vdelayxws                  },
  { "vdelayxw", S(VDELX),0, 5,  "a",  "aaiio", (SUBR)vdelxset, NULL, (SUBR)vdelayxw},
  { "vdelayxq", S(VDELXQ),0,5,  "aaaa", "aaaaaiio",
                                         (SUBR)vdelxqset, NULL, (SUBR)vdelayxq},
  { "vdelayxs", S(VDELXS),0,5,  "aa", "aaaiio", (SUBR)vdelxsset, NULL, (SUBR)vdelayxs},
