...
{ "tablekt",  S(TABL), TR|7,     "s",  "xkooo",tablkt_setup,  tablerkt_kontrol,
                                               tablerkt_audio                 },
{ "tableikt", S(TABL), TR|7,     "s",  "xkooo",tablkt_setup, tableirkt_kontrol,
                                               tableirkt_audio                },
  { "table3kt", S(TABL), TR|7,     "s",  "xkooo",tablkt_setup, table3rkt_kontrol,
                                                 table3rkt_audio              },
