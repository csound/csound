...
OENTRY opcodlst_1[] = {
    ...
    {"ctrlsave", S(SAVECTRL), 0, 3, "k[]", "im", savectrl_init, savectrl_perf,
     NULL, NULL},
    {"ctrlprint.S", S(PRINTCTRL), 0, 3, "", "k[]S", printctrl_init1, printctrl,
     NULL},
    {"ctrlprint", S(PRINTCTRL), 0, 3, "", "k[]", printctrl_init, printctrl,
     NULL},
    {"ctrlpreset", S(PRESETCTRL1), 0, 3, "k", "kk[]", presetctrl1_init,
     presetctrl1_perf, NULL},
    {"ctrlpreset", S(PRESETCTRL), 0, 3, "k", "kim", presetctrl_init,
     presetctrl_perf, NULL},
    {"ctrlselect", S(SELECTCTRL), 0, 3, "", "k", selectctrl_init,
     selectctrl_perf, NULL},
    {"ctrlprintpresets", S(PRINTPRESETS), 0, 3, "", "", printpresets_init,
     printpresets_perf, NULL},
    {"ctrlprintpresets.S", S(PRINTPRESETS), 0, 3, "", "S", printpresets_init1,
     printpresets_perf, NULL},
    ...
    /* VL: 10.2.22 this was thread 1, but with parser3 we need to make string
       assignment on threads 1 & 2 */
    {"=.S", S(STRCPY_OP), 0, 3, "S", "S", (SUBR)strcpy_opcode_S,
     (SUBR)strassign_k, (SUBR)NULL, NULL},
    /* VL: 11.2.22 this was thread 2, but with an update count, we need to be
       initialised */
    {"#=.S", S(STRCPY_OP), 0, 3, "S", "S", (SUBR)strcpy_opcode_S,
     (SUBR)strassign_k, (SUBR)NULL, NULL},
    {"=.T", S(STRCPY_OP), 0, 1, "S", "i", (SUBR)strcpy_opcode_p, (SUBR)NULL,
     (SUBR)NULL, NULL},
    {"=.r", S(ASSIGN), 0, 1, "r", "i", rassign, NULL, NULL, NULL},
    {"=.i", S(ASSIGNM), 0, 1, "IIIIIIIIIIIIIIIIIIIIIIII", "m", minit, NULL,
     NULL, NULL},
    ...
    */
    ...
    {"loscilphs", S(LOSCPHS), TR, 3, "amm", "xkjojoojoo", losset_phs,
     loscil_phs},
    {"loscil3phs", S(LOSCPHS), TR, 3, "amm", "xkjojoojoo", losset_phs,
     loscil3_phs},
    ...
    {"soundin", S(DISKIN2), 0, 3, "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm",
     "Soooo", sndinset_S, soundin},
    {"soundin.i", S(DISKIN2), 0, 3, "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm",
     "ioooo", sndinset, soundin},
    ...
    {"diskin", S(DISKIN2_ARRAY), 0, 3, "a[]", "SPooooooo",
     (SUBR)diskin_init_array_S, (SUBR)diskin2_perf_array},
    {"diskin2", S(DISKIN2_ARRAY), 0, 3, "a[]", "SPooooooo",
     (SUBR)diskin2_init_array_S, (SUBR)diskin2_perf_array},
    {"diskin.i", S(DISKIN2_ARRAY), 0, 3, "a[]", "iPooooooo",
     (SUBR)diskin_init_array_I, (SUBR)diskin2_perf_array},
    {"diskin2.i", S(DISKIN2_ARRAY), 0, 3, "a[]", "iPooooooo",
     (SUBR)diskin2_init_array_I, (SUBR)diskin2_perf_array},
    {"diskin", S(DISKIN2), 0, 3, "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm",
     "SPooooooo", (SUBR)diskin_init_S, (SUBR)diskin2_perf},
    {"diskin2", S(DISKIN2), 0, 3, "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm",
     "SPooooooo", (SUBR)diskin2_init_S, (SUBR)diskin2_perf},
    {"diskin.i", S(DISKIN2), 0, 3, "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm",
     "iPooooooo", (SUBR)diskin_init, (SUBR)diskin2_perf},
    ...
    {"noteondur", S(OUT_ON_DUR), 0, 3, "", "iiii", iout_on_dur_set, iout_on_dur,
     NULL},
    {"noteondur2", S(OUT_ON_DUR), 0, 3, "", "iiii", iout_on_dur_set,
     iout_on_dur2, NULL},
    ...
    {"outic14", S(OUT_CONTR14), 0, 1, "", "iiiiii", out_controller14, NULL,
     NULL},
    {"outkc14", S(OUT_CONTR14), 0, 2, "", "kkkkkk", NULL, out_controller14,
     NULL},
    ...
    {"outipat", S(OUT_POLYATOUCH), 0, 1, "", "iiiii", out_poly_aftertouch, NULL,
     NULL},
    {"outkpat", S(OUT_POLYATOUCH), 0, 2, "", "kkkkk", NULL, out_poly_aftertouch,
     NULL},
    ...
    {"logbtwo.a", S(EVAL), 0, 3, "a", "a", logbasetwo_set, logbasetwoa},
    ...
    {"tablew.aa", S(TABL), TW, 3, "", "aaiooo", (SUBR)tabl_setup,
     (SUBR)tablew_audio},
    {"tablewkt.kk", S(TABL), TW, 3, "", "kkkooo", (SUBR)tablkt_setup,
     (SUBR)tablewkt_kontrol, NULL},
    {"tablewkt.aa", S(TABL), TW, 3, "", "aakooo", (SUBR)tablkt_setup,
     (SUBR)tablewkt_audio},
    ...
    {"elapsedcycles.k", S(RDTIME), 0, 2, "k", "", NULL, (SUBR)elapsedcycles,
     NULL},
    {"elapsedcycles.i", S(RDTIME), 0, 1, "i", "", (SUBR)elapsedcycles, NULL,
     NULL},

    {"elapsedtime.k", S(RDTIME), 0, 2, "k", "", NULL, (SUBR)elapsedtime, NULL},
    {"elapsedtime.i", S(RDTIME), 0, 1, "i", "", (SUBR)elapsedtime, NULL, NULL},

    {"timeinstk", S(RDTIME), 0, 3, "k", "", (SUBR)instimset, (SUBR)instimek,
     NULL},
    {"timeinsts", S(RDTIME), 0, 3, "k", "", (SUBR)instimset, (SUBR)instimes,
     NULL},

    {"eventcycles", S(RDTIME), 0, 3, "k", "", (SUBR)instimset,
     (SUBR)eventcycles, NULL},
    {"eventtime", S(RDTIME), 0, 3, "k", "", (SUBR)instimset, (SUBR)eventtime,
     NULL},

    {"peak.k", S(PEAK), 0, 2, "k", "k", NULL, (SUBR)peakk, NULL},
    {"peak.a", S(PEAK), 0, 2, "k", "a", NULL, (SUBR)peaka},
    {"printk", S(PRINTK), WR, 3, "", "ikoooo", (SUBR)printkset, (SUBR)printk,
     NULL},
    {"printks", S(PRINTKS), WR, 3, "", "SiN", (SUBR)printksset_S, (SUBR)printks,
     NULL},
    {"printks2", sizeof(PRINTK3), 0, 3, "", "Sk", (SUBR)printk3set,
     (SUBR)printk3},
    {"printks.i", S(PRINTKS), WR, 3, "", "iiN", (SUBR)printksset, (SUBR)printks,
     NULL},
    {"prints", S(PRINTS), 0, 1, "", "SN", (SUBR)printsset_S, NULL, NULL},
    {"prints.i", S(PRINTS), 0, 1, "", "iN", (SUBR)printsset, NULL, NULL},
    {"printk2", S(PRINTK2), WR, 3, "", "koo", (SUBR)printk2set, (SUBR)printk2,
     NULL},
    ...
    {"aresonk", S(RESON), 0, 3, "k", "kkkpo", (SUBR)rsnset, (SUBR)kareson,
     NULL},
    ...
    {"in32", S(INALL), 0, 2, "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "", NULL,
     in32},
    {"inch", S(INCH1), 0, 3, "a", "k", inch1_set, (SUBR)inch_opcode1},
    {"inch.m", S(INCH), 0, 3, "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm", "z",
     inch_set, inch_opcode},
    ...
    */
    ...
    {"schedule", S(SCHED), 0, 1, "", "iiim", schedule, NULL, NULL},
    {"schedule.N", S(SCHED), 0, 1, "", "iiiN", schedule_N, NULL, NULL},
    {"schedule.S", S(SCHED), 0, 1, "", "Siim", schedule_S, NULL, NULL},
    {"schedule.SN", S(SCHED), 0, 1, "", "SiiN", schedule_SN, NULL, NULL},
    {"schedule.array", S(SCHED), 0, 1, "", "i[]", schedule_array, NULL, NULL},
    /* **** Experimental schedulek opcodes **** */
    {"schedulek", S(SCHED), 0, 2, "", "kkkM", NULL, schedule, NULL},
    {"schedulek.N", S(SCHED), 0, 2, "", "kkkN", NULL, schedule_N, NULL},
    {"schedulek.S", S(SCHED), 0, 2, "", "SkkM", NULL, schedule_S, NULL},
    {"schedulek.SN", S(SCHED), 0, 2, "", "SkkN", NULL, schedule_SN, NULL},
    {"schedulek.array", S(SCHED), 0, 2, "", "k[]", NULL, schedule_array, NULL},

    /* **** End of schedulek **** */
    {"schedwhen", S(WSCHED), 0, 3, "", "kkkkm", ifschedule, kschedule, NULL},
    {"schedwhen", S(WSCHED), 0, 3, "", "kSkkm", ifschedule, kschedule, NULL},
    {"schedkwhen", S(TRIGINSTR), 0, 3, "", "kkkkkz", triginset, ktriginstr,
     NULL},
    {"schedkwhen.S", S(TRIGINSTR), 0, 3, "", "kkkSkz", triginset_S,
     ktriginstr_S, NULL},
    {"schedkwhennamed", S(TRIGINSTR), 0, 3, "", "kkkkkz", triginset, ktriginstr,
     NULL},
    {"schedkwhennamed.S", S(TRIGINSTR), 0, 3, "", "kkkSkz", triginset_S,
     ktriginstr_S, NULL},
    ...
    {"nstance.kS", S(LINEVENT2), 0, 2, "k", "SSz", NULL, instanceOpcode_S,
     NULL},
    {"nstance.S", S(LINEVENT2), 0, 1, "i", "Siim", instanceOpcode_S, NULL,
     NULL},
    ...
    {"oscils", S(OSCILS), 0, 3, "a", "iiio", (SUBR)oscils_set, (SUBR)oscils},
    {"lphasor", S(LPHASOR), 0, 3, "a", "xooooooo", (SUBR)lphasor_set,
     (SUBR)lphasor},
    {"tablexkt", S(TABLEXKT), TR, 3, "a", "xkkiooo", (SUBR)tablexkt_set,
     (SUBR)tablexkt},
    {"reverb2", S(NREV2), 0, 3, "a", "akkoojoj", (SUBR)reverbx_set,
     (SUBR)reverbx},
    {"nreverb", S(NREV2), 0, 3, "a", "akkoojoj", (SUBR)reverbx_set,
     (SUBR)reverbx},
    ...
    {"miditempo", S(MIDITEMPO), 0, 3, "k", "", (SUBR)midiTempoOpcode,
     (SUBR)midiTempoOpcode, NULL},
    ...
    {"midinoteonkey", S(MIDINOTEON), 0, 3, "", "xx", midinoteonkey,
     midinoteonkey},
    {"midinoteoncps", S(MIDINOTEON), 0, 3, "", "xx", midinoteoncps,
     midinoteoncps},
    {"midinoteonoct", S(MIDINOTEON), 0, 3, "", "xx", midinoteonoct,
     midinoteonoct},
    {"midinoteonpch", S(MIDINOTEON), 0, 3, "", "xx", midinoteonpch,
     midinoteonpch},
    {"midipolyaftertouch", S(MIDIPOLYAFTERTOUCH), 0, 3, "", "xxoh",
     midipolyaftertouch, midipolyaftertouch},
    {"midicontrolchange", S(MIDICONTROLCHANGE), 0, 3, "", "xxoh",
     midicontrolchange, midicontrolchange},
    {"midiprogramchange", S(MIDIPROGRAMCHANGE), 0, 3, "", "x",
     midiprogramchange, midiprogramchange},
    {"midichannelaftertouch", S(MIDICHANNELAFTERTOUCH), 0, 3, "", "xoh",
     midichannelaftertouch, midichannelaftertouch},
    {"midipitchbend", S(MIDIPITCHBEND), 0, 3, "", "xoh", midipitchbend,
     midipitchbend},
    {"mididefault", S(MIDIDEFAULT), 0, 3, "", "xx", mididefault, mididefault},
    //{ "invalue",   0xFFFF,   _CR,    0,   NULL,   NULL, NULL, NULL },
    {"invalue.k", S(INVAL), _CR, 3, "k", "i", (SUBR)invalset, (SUBR)kinval,
     NULL},
    {"invalue.i", S(INVAL), _CR, 1, "i", "i", (SUBR)invalsetgo, NULL, NULL},
    {"invalue.iS", S(INVAL), _CR, 1, "i", "S", (SUBR)invalsetSgo, NULL, NULL},
    {"invalue.kS", S(INVAL), _CR, 3, "k", "S", (SUBR)invalset_S, (SUBR)kinval,
     NULL},
    {"invalue.S", S(INVAL), _CR, 3, "S", "i", (SUBR)invalset_string,
     (SUBR)kinvalS, NULL},
    {"invalue.SS", S(INVAL), _CR, 3, "S", "S", (SUBR)invalset_string_S,
     (SUBR)kinvalS, NULL},
    {"outvalue", S(OUTVAL), _CW, 3, "", "ik", (SUBR)outvalset, (SUBR)koutval,
     NULL},
    {"outvalue.i", S(OUTVAL), _CW, 1, "", "ii", (SUBR)outvalsetgo, NULL, NULL},
    {"outvalue.Si", S(OUTVAL), _CW, 1, "", "Si", (SUBR)outvalsetSgo, NULL,
     NULL},
    {"outvalue.k", S(OUTVAL), _CW, 3, "", "Sk", (SUBR)outvalset_S,
     (SUBR)koutval, NULL},
    {"outvalue.S", S(OUTVAL), _CW, 3, "", "iS", (SUBR)outvalset_string,
     (SUBR)koutvalS, NULL},
    {"outvalue.SS", S(OUTVAL), _CW, 3, "", "SS", (SUBR)outvalset_string_S,
     (SUBR)koutvalS, NULL},
    /* IV - Oct 20 2002 */
    ...
    {"integ", S(INDIFF), 0, 3, "a", "xo", (SUBR)indfset, (SUBR)integrate},
    {"integ.k", S(INDIFF), 0, 3, "k", "xo", (SUBR)indfset, (SUBR)kntegrate,
     NULL},
    {"diff", S(INDIFF), 0, 3, "a", "xo", (SUBR)indfset, (SUBR)diff},
    {"diff.k", S(INDIFF), 0, 3, "k", "xo", (SUBR)indfset, (SUBR)kdiff, NULL},
    {"samphold", S(SAMPHOLD), 0, 3, "a", "xxoo", (SUBR)samphset,
     (SUBR)samphold},
    {"samphold.k", S(SAMPHOLD), 0, 3, "k", "xxoo", (SUBR)samphset,
     (SUBR)ksmphold, NULL},
    ...
    {"vdelayxwq", S(VDELXQ), 0, 3, "aaaa", "aaaaaiio", (SUBR)vdelxqset,
     (SUBR)vdelayxwq},
    {"vdelayxws", S(VDELXS), 0, 3, "aa", "aaaiio", (SUBR)vdelxsset,
     (SUBR)vdelayxws},
    {"vdelayxw", S(VDELX), 0, 3, "a", "aaiio", (SUBR)vdelxset, (SUBR)vdelayxw},
    {"vdelayxq", S(VDELXQ), 0, 3, "aaaa", "aaaaaiio", (SUBR)vdelxqset,
     (SUBR)vdelayxq},
    {"vdelayxs", S(VDELXS), 0, 3, "aa", "aaaiio", (SUBR)vdelxsset,
     (SUBR)vdelayxs},
    ...
    {"multitap", S(MDEL), 0, 3, "a", "am", (SUBR)multitap_set,
     (SUBR)multitap_play},
    ...
    {"strset", S(STRSET_OP), 0, 1, "", "iS", (SUBR)strset_init, NULL, NULL},
    {"strget", S(STRGET_OP), 0, 1, "S", "i", (SUBR)strget_init, NULL, NULL},
    {"S", S(STRGET_OP), 0, 1, "S", "i", (SUBR)s_opcode, NULL, NULL},
    {"S", S(STRGET_OP), 0, 3, "S", "k", (SUBR)s_opcode, (SUBR)s_opcode_k, NULL},
    {"strcpy", S(STRCPY_OP), 0, 1, "S", "S", (SUBR)strcpy_opcode_S, NULL, NULL},
    {"strcpy", S(STRGET_OP), 0, 1, "S", "i", (SUBR)strcpy_opcode_p, NULL, NULL},
    {"strcpyk", S(STRCPY_OP), 0, 3, "S", "S", (SUBR)strcpy_opcode_S,
     (SUBR)strcpy_opcode_S, NULL},
    {"strcpyk.k", S(STRGET_OP), 0, 3, "S", "k", (SUBR)strcpy_opcode_p,
     (SUBR)strcpy_opcode_p, NULL},
    {"strcat", S(STRCAT_OP), 0, 1, "S", "SS", (SUBR)strcat_opcode, NULL, NULL},
    {"strcatk", S(STRCAT_OP), 0, 3, "S", "SS", (SUBR)strcat_opcode,
     (SUBR)strcat_opcode, NULL},
    {"strcmp", S(STRCMP_OP), 0, 1, "i", "SS", (SUBR)strcmp_opcode, NULL, NULL},
    {"strcmpk", S(STRCMP_OP), 0, 3, "k", "SS", (SUBR)strcmp_opcode,
     (SUBR)strcmp_opcode, NULL},
    {"sprintf", S(SPRINTF_OP), 0, 1, "S", "STN", (SUBR)sprintf_opcode, NULL,
     NULL},
    {"sprintfk", S(SPRINTF_OP), WR, 3, "S", "SUN", (SUBR)sprintf_opcode,
     (SUBR)sprintf_opcode, NULL},
    ...
    {"puts", S(PUTS_OP), WR, 3, "", "Sko", (SUBR)puts_opcode_init,
     (SUBR)puts_opcode_perf, NULL},
    {"strtod", S(STRSET_OP), 0, 1, "i", "S", (SUBR)strtod_opcode_S, NULL, NULL},
    {"strtod", S(STRTOD_OP), 0, 1, "i", "i", (SUBR)strtod_opcode_p, NULL, NULL},
    {"strtodk", S(STRSET_OP), 0, 3, "k", "S", (SUBR)strtod_opcode_S,
     (SUBR)strtod_opcode_S, NULL},
    {"strtol", S(STRSET_OP), 0, 1, "i", "S", (SUBR)strtol_opcode_S, NULL, NULL},
    {"strtol", S(STRTOD_OP), 0, 1, "i", "i", (SUBR)strtol_opcode_p, NULL, NULL},
    {"strtolk", S(STRSET_OP), 0, 3, "k", "S", (SUBR)strtol_opcode_S,
     (SUBR)strtol_opcode_S, NULL},
    {"strsub", S(STRSUB_OP), 0, 1, "S", "Soj", (SUBR)strsub_opcode, NULL, NULL},
    {"strsubk", S(STRSUB_OP), 0, 3, "S", "Skk", (SUBR)strsub_opcode,
     (SUBR)strsub_opcode, NULL},
    {"strchar", S(STRCHAR_OP), 0, 1, "i", "So", (SUBR)strchar_opcode, NULL,
     NULL},
    {"strchark", S(STRCHAR_OP), 0, 3, "k", "SO", (SUBR)strchar_opcode,
     (SUBR)strchar_opcode, NULL},
    {"strlen", S(STRLEN_OP), 0, 1, "i", "S", (SUBR)strlen_opcode, NULL, NULL},
    {"strlenk", S(STRLEN_OP), 0, 3, "k", "S", (SUBR)strlen_opcode,
     (SUBR)strlen_opcode, NULL},
    {"strupper", S(STRUPPER_OP), 0, 1, "S", "S", (SUBR)strupper_opcode, NULL,
     NULL},
    {"strupperk", S(STRUPPER_OP), 0, 3, "S", "S", (SUBR)strupper_opcode,
     (SUBR)strupper_opcode, NULL},
    {"strlower", S(STRUPPER_OP), 0, 1, "S", "S", (SUBR)strlower_opcode, NULL,
     NULL},
    {"strlowerk", S(STRUPPER_OP), 0, 3, "S", "S", (SUBR)strlower_opcode,
     (SUBR)strlower_opcode, NULL},
    {"getcfg", S(GETCFG_OP), 0, 1, "S", "i", (SUBR)getcfg_opcode, NULL, NULL},
    {"strindex", S(STRINDEX_OP), 0, 1, "i", "SS", (SUBR)strindex_opcode, NULL,
     NULL},
    {"strindexk", S(STRINDEX_OP), 0, 3, "k", "SS", (SUBR)strindex_opcode,
     (SUBR)strindex_opcode, NULL},
    {"strrindex", S(STRINDEX_OP), 0, 1, "i", "SS", (SUBR)strrindex_opcode, NULL,
     NULL},
    {"strrindexk", S(STRINDEX_OP), 0, 3, "k", "SS", (SUBR)strrindex_opcode,
     (SUBR)strrindex_opcode, NULL},
    {"print_type", S(PRINT_TYPE_OP), 0, 1, "", ".", (SUBR)print_type_opcode,
     NULL, NULL},
#ifdef HAVE_CURL
    {"strfromurl", S(STRCPY_OP), 0, 1, "S", "S", (SUBR)str_from_url},
#endif
    {"changed.S", S(STRCHGD), 0, 3, "k", "S", (SUBR)str_changed,
     (SUBR)str_changed_k, NULL},
    {"changed2.S", S(STRCHGD), 0, 3, "k", "S", (SUBR)str_changed,
     (SUBR)str_changed_k, NULL},
    ...
    {"chnget", 0xFFFF, _CR},
    {"chnget.i", S(CHNGET), _CR, 1, "i", "S", (SUBR)chnget_opcode_init_i, NULL,
     NULL},
    {"chnget.k", S(CHNGET), _CR, 3, "k", "S", (SUBR)chnget_opcode_init_k,
    ...
    {"chngetk.k", S(CHNGET), _CR, 3, "k[]", "S[]",
     (SUBR)chnget_array_opcode_init, (SUBR)notinit_opcode_stub, NULL},
    {"chnget.a", S(CHNGET), _CR, 3, "a", "S", (SUBR)chnget_opcode_init_a,
     (SUBR)notinit_opcode_stub},
    {"chnget.S", S(CHNGET), _CR, 3, "S", "S", (SUBR)chnget_opcode_init_S,
     (SUBR)chnget_opcode_perf_S, NULL},
    {"chngetks", S(CHNGET), _CR, 2, "S", "S", NULL, (SUBR)chnget_opcode_perf_S,
     NULL},
    //{ "chnset",      0xFFFB,              _CW                               },
    ...
    {"chnset.i", S(CHNGET), _CW, 1, "", "iS", (SUBR)chnset_opcode_init_i, NULL,
     NULL},
    //  { "chnset.r",    S(CHNGET),0,           1,      "",             "iS",
    //    (SUBR) chnset_opcode_init_i, NULL, NULL               },
    //  { "chnset.c",    S(CHNGET),0,           1,      "",             "iS",
    //    (SUBR) chnset_opcode_init_i, NULL, NULL               },
    {"chnset.k", S(CHNGET), _CW, 3, "", "kS", (SUBR)chnset_opcode_init_k,
     (SUBR)notinit_opcode_stub, NULL},
    {"chnset.a", S(CHNGET), _CW, 3, "", "aS", (SUBR)chnset_opcode_init_a,
     (SUBR)notinit_opcode_stub},
    {"chnset.S", S(CHNGET), _CW, 3, "", "SS", (SUBR)chnset_opcode_init_S,
     (SUBR)chnset_opcode_perf_S, NULL},
    {"chnsetks", S(CHNGET), _CW, 2, "", "SS", NULL, (SUBR)chnset_opcode_perf_S,
     NULL},
    {"chnmix", S(CHNGET), _CB, 3, "", "aS", (SUBR)chnmix_opcode_init,
     (SUBR)notinit_opcode_stub},
    {"chnclear", S(CHNCLEAR), _CW, 3, "", "W", (SUBR)chnclear_opcode_init,
     (SUBR)notinit_opcode_stub},
    ...
    {"chn_a", S(CHN_OPCODE), _CW, 1, "", "Si", (SUBR)chn_a_opcode_init, NULL,
     NULL},
    {"chn_S", S(CHN_OPCODE), _CW, 1, "", "Si", (SUBR)chn_S_opcode_init, NULL,
     NULL},
    ...
    */
    ...
    {"chano.k", S(ASSIGN), _CW, 2, "", "kk", NULL, (SUBR)chano_opcode_perf_k,
     NULL},
    {"chano.a", S(ASSIGN), _CW, 2, "", "ak", NULL, (SUBR)chano_opcode_perf_a},
    {"pvsout", S(FCHAN), 0, 3, "", "fk", (SUBR)pvsout_init, (SUBR)pvsout_perf,
     NULL},
    //{ "chani",      0xFFFF,  _CR,      0,   NULL, NULL, NULL, NULL },
    {"chani.k", S(ASSIGN), _CR, 2, "k", "k", NULL, (SUBR)chani_opcode_perf_k,
     NULL},
    {"chani.a", S(ASSIGN), _CR, 2, "a", "k", NULL, (SUBR)chani_opcode_perf_a},
    {"pvsin", S(FCHAN), 0, 3, "f", "kooopo", (SUBR)pvsin_init, (SUBR)pvsin_perf,
     NULL},
    {"sense", S(KSENSE), 0, 2, "kz", "", NULL, (SUBR)sensekey_perf, NULL},
    {"sensekey", S(KSENSE), 0, 2, "kz", "", NULL, (SUBR)sensekey_perf, NULL},
    {"remove", S(DELETEIN), 0, 1, "", "T", (SUBR)delete_instr, NULL, NULL},
    ...
    {"passign", S(PINIT), 0, 1, "IIIIIIIIIIIIIIIIIIIIIIII", "po", (SUBR)pinit,
     NULL, NULL},
    ...
    {"outrg", S(OUTRANGE), IR, 3, "", "ky", (SUBR)outRange_i, (SUBR)outRange},
    {"nchnls_hw", S(ASSIGN), 0, 1, "ii", "", (SUBR)hw_channels},
    {"midiarp", S(MIDIARP), 0, 3, "kk", "kO", midiarp_set, midiarp, NULL},
    {"lpcfilter", S(LPCFIL), 0, 3, "a", "akkiiio", (SUBR)lpfil_init,
     (SUBR)lpfil_perf},
    {"lpcfilter", S(LPCFIL2), 0, 3, "a", "aakkiio", (SUBR)lpfil2_init,
     (SUBR)lpfil2_perf},
    {"allpole", S(LPCFIL3), 0, 3, "a", "ak[]", (SUBR)lpfil3_init,
     (SUBR)lpfil3_perf},
    {"lpcanal", S(LPREDA), 0, 3, "k[]kkk", "kkiiio", (SUBR)lpred_alloc,
     (SUBR)lpred_run},
    {"lpcanal", S(LPREDA2), 0, 3, "k[]kkk", "akkiio", (SUBR)lpred_alloc2,
     (SUBR)lpred_run2},
    {"lpcanal", S(LPREDA), 0, 1, "i[]iii", "iiii", (SUBR)lpred_i, NULL},
    {"pvslpc", S(LPCPVS), 0, 3, "f", "aiiio", (SUBR)lpcpvs_init, (SUBR)lpcpvs},
    {"pvscfs", S(PVSCFS), 0, 3, "k[]kk", "fip", (SUBR)pvscoefs_init,
     (SUBR)pvscoefs},
    {"apoleparams", S(CF2P), 0, 3, "k[]", "k[]", (SUBR)coef2parm_init,
     (SUBR)coef2parm},
    {"resonbnk", S(RESONB), 0, 3, "a", "ak[]kkipoo", (SUBR)resonbnk_init,
     (SUBR)resonbnk},
