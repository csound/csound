...
declare interface CsoundObj {
     ...
     */
    on: (eventName: PublicEvents, listener: EventEmitter.EventListener<PublicEvents, any>) => EventEmitter;
    /**
     * Alias for "on"
     */
    addListener: (eventName: PublicEvents, listener: EventEmitter.EventListener<PublicEvents, any>) => EventEmitter;
    /**
     * Adds a one-time listener for the event named eventName.
     * The next time eventName is triggered, this listener is removed and then invoked.
     */
    once: (eventName: PublicEvents, listener: EventEmitter.EventListener<PublicEvents, any>) => EventEmitter;
    /**
     ...
     * return undefined.
     */
    csoundGetNamedGEN: (tableNum: string) => Promise<string | undefined>;
}
