...
// PUBLIC void 	csoundAddSpinSample (CSOUND *csound, int frame, int channel, cs_float sample)
// PUBLIC void 	csoundSetSpinSample (CSOUND *csound, int frame, int channel, cs_float sample)

// PUBLIC cs_float 	csoundGetSpoutSample (CSOUND *csound, int frame, int channel)
...
// PUBLIC void 	csoundSetRtplayCallback (CSOUND *, void(*rtplay__)(CSOUND *, const cs_float *outBuf, int nbytes))
// PUBLIC void 	csoundSetRecopenCallback (CSOUND *, int(*recopen_)(CSOUND *, const csRtAudioParams *parm))
// PUBLIC void 	csoundSetRtrecordCallback (CSOUND *, int(*rtrecord__)(CSOUND *, cs_float *inBuf, int nbytes))
