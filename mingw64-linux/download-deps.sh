...
packages=($pthreads $portaudio_src $portmidi_src $flac_src $ogg_src $vorbis_src $libsndfile_src $liblo_src $wiiuse_src $fltk_src $png_src $boost_src $fluidsynth_src $luajit_src)
