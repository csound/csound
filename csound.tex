...
The \texttt{OENTRY} structure follows this format:
...
\begin{description}  
	\item[\texttt{dspace}] A flag that specifies what types of polymorphism are allowed (see \texttt{Engine/entry1.c} and \texttt{Engine/rdorch.c}), as follows:
