...
\begin{description}  
	\item[dspace] the size field is used as a flag in saying what types of polymorphism are allowed (look at Engine/entry1.c and Engine/rdorch.c)
	...
	\item[thread] the rate(s) at which the opcode is able to run at
	
	\item[outargs] a listing of the arguments this opcode will emit, if any.  The types allowed are:
	...
	\item[inargs] a listing of the arguments this opcode will take, if any.  The types allowed are: 
			...
			M & begins an indef list of args (any count and rate) \\
	...
	\item[isub] a reference to the function that will run at i-time for this opcode
	\item[ksub] a reference to the function that will run at k-time for this opcode
	\item[asub] a reference to the function that will run at a-time for this opcode
	\item[dsub] a reference to the function that will run at the end of csound run
