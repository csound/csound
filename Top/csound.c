...
void csoundSetSpinSample(CSOUND *csound, int frame,
...
void csoundAddSpinSample(CSOUND *csound, int frame,
                                int channel, MYFLT sample)
{
