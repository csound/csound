...
static int32_t csoundFileCommand(CSOUND *csound, void *handle, int cmd,
...
static const CSOUND cenviron_ = {
    ...
    (void (*)(CSOUND *, const char *, int, int,
              int))NULL, /* FileOpenCallback_ */
    ...
    (OPDS *)NULL, /*  ids                 */
    {
        ...
        (INSTRTXT **)NULL,
        {NULL,
         {0, 0, NULL, NULL, NULL, NULL, 0, 0, NULL, 0, 0},
         0,
         0,
         0,
         // 0,
    ...
    {NULL,
     ...
     0,
     0,
     1,    /*  repeat_cnt, repeat_point, repeat_inc */
     NULL, /*  repeat_mm */
     0},
    {
...
int DummyMidiInOpen(CSOUND *csound, void **userData, const char *devName);
int DummyMidiRead(CSOUND *csound, void *userData, unsigned char *buf,
                  int nbytes);
int DummyMidiOutOpen(CSOUND *csound, void **userData, const char *devName);
int DummyMidiWrite(CSOUND *csound, void *userData, const unsigned char *buf,
                   int nbytes);
/* random.c */
...
PUBLIC void csoundSetHostImplementedAudioIO(CSOUND *csound, int state,
                                            int bufSize) {
...
PUBLIC void csoundSetDefaultMessageCallback(void (*csoundMessageCallback)(
    CSOUND *csound, int attr, const char *format, va_list args)) {
...
PUBLIC void csoundSetMessageStringCallback(
    CSOUND *csound, void (*csoundMessageStrCallback)(CSOUND *csound, int attr,
                                                     const char *str)) {
...
PUBLIC void csoundMessageV(CSOUND *csound, int attr, const char *format,
                           va_list args) {
...
void csoundErrorMsgS(CSOUND *csound, int attr, const char *msg, ...) {
  va_list args;
  va_start(args, msg);
...
int audio_dev_list_dummy(CSOUND *csound, CS_AUDIODEVICE *list, int isOutput) {
  IGN(csound);
  IGN(list);
  IGN(isOutput);
  return 0;
...
PUBLIC void csoundSetPlayopenCallback(
    CSOUND *csound, int (*playopen__)(CSOUND *, const csRtAudioParams *parm)) {
...
PUBLIC void csoundSetRecopenCallback(
    CSOUND *csound, int (*recopen__)(CSOUND *, const csRtAudioParams *parm)) {
...
PUBLIC void csoundSetExternalMidiReadCallback(
    CSOUND *csound, int (*func)(CSOUND *, void *, unsigned char *, int)) {
...
PUBLIC void csoundSetExternalMidiWriteCallback(
    CSOUND *csound, int (*func)(CSOUND *, void *, const unsigned char *, int)) {
...
PUBLIC int csoundAppendOpcode(CSOUND *csound, const char *opname, int dsblksiz,
...
void SetInternalYieldCallback(CSOUND *csound, int (*yieldCallback)(CSOUND *)) {
...
PUBLIC int csoundRegisterKeyboardCallback(
    CSOUND *csound, int (*func)(void *userData, void *p, unsigned int type),
...
char *csoundGetOutputArgName(void *p, int n) {
  if ((unsigned int)n >= (unsigned int)((OPDS *)p)->optext->t.outArgCount)
    return (char *)NULL;
...
int csoundErrCnt(CSOUND *csound) {
