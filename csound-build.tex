	...
	\item (Done) Update the build tools.   
		\begin{enumerate}
  		\item (Done) Update Python.
	    		...
	    		\item (13 June 2010) Update SCons from \url{www.scons.org} to the most recent ``standard'' version (currenty 1.3.0).
			...
			\item (13 June 2010) Install the latest version of the Twilight Dragon Media build of MinGW from \url{http://www.tdragon.net} (currently 4.5.0). The sjlj version of the compiler must be used instead of the dw2 version, even though the dw2 compiler builds somewhat faster code, because the dw2 compiler generates buggy code for DLL relocations.
	    ...
	    \item (13 June 2010) Update SWIG from \url{www.swig.org} to the most recent ``standard'' version (currently 2.0.0).
