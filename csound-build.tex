...
\end{lstlisting}
			...
			Rebuild QuteCsound in its src directory using the following commands, possibly with INCLUDEPATH and LIBPATH modified for your system:
...
mingw32-make release
			...
			\begin{lstlisting}
qmake "CONFIG += build32" INCLUDEPATH+=D:\utah\home\mkg\csoundf\H INCLUDEPATH+=D:\utah\home\mkg\csoundf\interfaces INCLUDEPATH+=D:\utah\opt\Mega-Nerd\libsndfile\include LIBPATH+=D:\utah\home\mkg\csoundf LIBPATH+=D:\utah\opt\Mega-Nerd\libsndfile
mingw32-make release
			\end{lstlisting}
