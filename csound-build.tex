...
\begin{enumerate}
	...
	\item (Done) Update the build tools.   
		\begin{enumerate}
			...
			\item (Done) For MinGW/MSys from \url{www.mingw.org}, update to MinGW version 4.2.1-2 with dw exception handling from \url{http://sourceforge.net/projects/mingw} Then add the latest MSys base and MSys supplementary tools from \url{http://sourceforge.net/projects/mingw}. Also, add pkg.m4 from \url{http://johnnypops.demon.co.uk/mingw/msys-pkg-config-win32.zip}.
