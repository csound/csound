...
\begin{enumerate}
	...
	\item (Done) Fix bugs in \texttt{csound5gui}.
	...
	\item Fix up installers for correct third party DLLs.
	\item Fix up installers for correct Csound examples.
	\item Make sure installers link to the frames version of the manual and include the quick reference.
