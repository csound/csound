...
for release for the Windows installers -- on Michael Gogins' computer.

Drive "U:" is mapped to a directory containing all required
pre-built third-party libraries in the paths used below.
...
if sys.platform[:3] == 'win':
    ...
    customLIBPATH.append(r'D:\utah\home\mkg\projects\portaudio\build\msvc\Win32\Debug')
    ################################################################
    ...
    # Add it here:
    customCPPPATH.append(r'U:\lua-5.1.1\src')
    customLIBPATH.append(r'U:\lua-5.1.1\src')
    ################################################################
    ...
    #customLIBPATH.append(r'U:\fluidsynth-1.0.3-win32')
    #customCPPPATH.append(r'U:\fluidsynth-1.0.3-win32\include')
