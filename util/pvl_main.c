...
#include <stdio.h>     // for vfprintf, NULL, stderr, stdout, va_list

#include "csound.h"    // for csoundCreate, csoundDestroy, csoundRunUtility
#include "msg_attr.h"  // for CSOUNDMSG_ORCH, CSOUNDMSG_TYPE_MASK
