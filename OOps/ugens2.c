...
int tabl3(TABLE  *p)           /* Like tabli but cubic interpolation */
{
    FUNC        *ftp;
    long        indx, mask, length;
    int nsmps = ksmps;
