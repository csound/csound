/*
    ...
    Copyright (C) 2005 Istvan Varga, Andrés Cabrera
    ...
    02111-1307 USA
*/
// Takes some things from amidi.c file by Clemens Ladisch from the alsa sources
// Since that file is licensed GPL, this file must be GPL as well, so it is
// incompatible with the current Csound license and must be distributed
// separately
