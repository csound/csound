...
CSOUNDLIBS=../../CsoundAndroid

mkdir -p $JNILIBS 
mkdir -p $JNILIBS/armeabi
mkdir -p $JNILIBS/armeabi-v7a

cp -f $CSOUNDLIBS/libs/armeabi/*.so $JNILIBS/armeabi/
...
cp -f $CSOUNDLIBS/libs/armeabi-v7a/*.so $JNILIBS/armeabi-v7a/
...
cp -f $PLUGINLIBS/LuaCsound/libs/armeabi-v7a/*.so $JNILIBS/armeabi-v7a/
...
#rm -f $JNILIBS/armeabi/libc++_shared.so
