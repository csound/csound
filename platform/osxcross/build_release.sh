...
for ARCH in x86_64 arm64; do
    ...
    prefix=$dir/bin/osxcross-$ARCH/release
...
prefix=$dir/bin/osxcross/release
prefix_x64=$dir/bin/osxcross-x86_64/release
prefix_arm64=$dir/bin/osxcross-arm64/release
