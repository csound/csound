...
-(void)addListener:(id<CsoundObjListener>)listener; // addListener
...
- (double *)getInputChannelPtr:(NSString *)channelName
                   channelType:(controlChannelType)channelType;
- (double *)getOutputChannelPtr:(NSString *)channelName
                    channelType:(controlChannelType)channelType;
