...
namespace csound
{
  ...
  public:
     ...
     */
    virtual void jonesParksGrain(double centerTime, double duration, double beginningFrequency, d
				 ouble centerFrequency, double centerAmplitude, double centerPhase, double pan);
    /**
