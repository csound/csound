...
PUBLIC void csoundapi_tilde_setup(void)
{
  ...
  class_addmethod(csoundapi_class, (t_method) csoundapi_ctlchg, gensym("ctlchg"), A_DEFFLOAT, A_DEFFLOAT, A_DEFFLOAT, 0);
  class_addmethod(csoundapi_class, (t_method) csoundapi_pgmchg, gensym("pgmchg"), A_DEFFLOAT, A_DEFFLOAT, 0);
  class_addmethod(csoundapi_class, (t_method) csoundapi_polytouch, gensym("polytouch"), A_DEFFLOAT, A_DEFFLOAT, A_DEFFLOAT, 0);
  class_addmethod(csoundapi_class, (t_method) csoundapi_touch, gensym("touch"), A_DEFFLOAT, A_DEFFLOAT, 0);
  class_addmethod(csoundapi_class, (t_method) csoundapi_bend, gensym("bend"), A_DEFFLOAT, A_DEFFLOAT, 0);
...
static void csoundapi_noteon(t_csoundapi *x, t_floatarg note, t_floatarg vel, t_floatarg chan)
{
  MIDI_COMMON;
...
static void csoundapi_noteoff(t_csoundapi *x, t_floatarg note, t_floatarg vel, t_floatarg chan)
{
  MIDI_COMMON;
...
static void csoundapi_ctlchg(t_csoundapi *x, t_floatarg value, t_floatarg ctrl, t_floatarg chan)
{
  MIDI_COMMON;
...
static void csoundapi_polytouch(t_csoundapi *x, t_floatarg note, t_floatarg vel, t_floatarg chan)
{
  MIDI_COMMON;
