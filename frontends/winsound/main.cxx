...
void cs_compile_run(void)
{
    ...
    if (do_load) {
      ...
      if (size_8->value())
        argv[nxt++] = "-c";
      else if (size_16->value())
        argv[nxt++] = "-s";
      else if (size_32->value())
        argv[nxt++] = "-l";
      else if (size_f->value())
        argv[nxt++] = "-f";
      else if (size_24->value())
        argv[nxt++] = "-3";
      prof.get("r", itmp, -1);
      if (itmp >= 0) {
        sprintf(b3, "-r%d", itmp);
...
void cs_util_het(void)
{
    ...
    if (do_util > 0) {
      ...
      prof_h.set("c", het_c1->value() ? 1 :
                 het_c2->value() ? 2 :
                 het_c3->value() ? 3 : het_c4->value() ? 4 : 0);
      textw->show();
      hw->hide();
      argv[0] = "hetro";
      if (het_s->value() != 0) {
      ...
      if (het_c1->value())
        argv[nxt++] = "-c1";
      else if (het_c2->value())
        argv[nxt++] = "-c2";
      else if (het_c3->value())
        argv[nxt++] = "-c3";
      else if (het_c4->value())
        argv[nxt++] = "-c4";
...
void cs_util_lpc(void)
{
    ...
    if (do_util > 0) {
      ...
      prof_l.set("c", lpc_c1->value() ? 1 :
                 lpc_c2->value() ? 2 :
                 lpc_c3->value() ? 3 : lpc_c4->value() ? 4 : 0);
      textw->show();
      hw->hide();
      argv[0] = "lpanal";
      if (lpc_s->value() != 0) {
      ...
      if (lpc_c1->value())
        argv[nxt++] = "-c1";
      else if (lpc_c2->value())
        argv[nxt++] = "-c2";
      else if (lpc_c3->value())
        argv[nxt++] = "-c3";
      else if (lpc_c4->value())
        argv[nxt++] = "-c4";
...
void cs_util_pvc(void)
{
    ...
    if (do_util > 0) {
      ...
      prof_p.set("c", pvc_c1->value() ? 1 :
                 pvc_c2->value() ? 2 :
                 pvc_c3->value() ? 3 : pvc_c4->value() ? 4 : 0);
      textw->show();
      hw->hide();
      argv[0] = "pvanal";
      if (pvc_s->value() != 0) {
      ...
      if (pvc_c1->value())
        argv[nxt++] = "-c1";
      else if (pvc_c2->value())
        argv[nxt++] = "-c2";
      else if (pvc_c3->value())
        argv[nxt++] = "-c3";
      else if (pvc_c4->value())
        argv[nxt++] = "-c4";
...
void cs_util_cvl(void)
{
    ...
    if (do_util > 0) {
      ...
      prof_c.set("c", cvl_c1->value() ? 1 :
                 cvl_c2->value() ? 2 :
                 cvl_c3->value() ? 3 : cvl_c4->value() ? 4 : 0);
      textw->show();
      hw->hide();
      argv[0] = "cvanal";
      if (cvl_s->value() != 0) {
      ...
      if (cvl_c1->value())
        argv[nxt++] = "-c1";
      else if (cvl_c2->value())
        argv[nxt++] = "-c2";
      else if (cvl_c3->value())
        argv[nxt++] = "-c3";
      else if (cvl_c4->value())
        argv[nxt++] = "-c4";
...
void cs_util_dnoise(void)
{
    ...
    if (do_util > 0) {
      ...
      argv[nxt++] = "-o";
      argv[nxt++] = (char *) dns_analout->value();
      argv[nxt++] = "-i";
      argv[nxt++] = (char *) dns_noise->value();
...
void savetext(Fl_Text_Buffer *b, int type)
{
    ...
    if (do_util > 0) {
      if (type == 0)
        b->outputfile(savefile->value(), 0, b->length());
      else {
        int     start, end;
