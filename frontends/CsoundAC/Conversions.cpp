    ...
    if(!initialized_)
      {
        ...
        listPitchClassSets();
        // Intervals.
        fill((char*)" minor second",     "C  C#                             ");
        fill((char*)" major second",     "C     D                           ");
        fill((char*)" minor third",      "C        Eb                       ");
        fill((char*)" major third",      "C           E                     ");
        fill((char*)" perfect fourth",   "C              F                  ");
        fill((char*)" tritone",          "C                 F#              ");
        fill((char*)" perfect fifth",    "C                    G            ");
        fill((char*)" augmented fifth",  "C                       G#        ");
        fill((char*)" sixth",            "C                          A      ");
        fill((char*)" minor seventh  ",  "C                             Bb  ");
        fill((char*)" major seventh",    "C                                B");
        // Scales.
        fill((char*)" major",            "C     D     E  F     G     A     B");
        fill((char*)" minor",            "C     D  Eb    F     G  Ab    Bb  ");
        fill((char*)" natural minor",    "C     D  Eb    F     G  Ab    Bb  ");
        fill((char*)" harmonic minor",   "C     D  Eb    F     G  Ab       B");
        fill((char*)" chromatic",        "C  C# D  D# E  F  F# G  G# A  A# B");
        fill((char*)" whole tone",       "C     D     E     F#    G#    A#  ");
        fill((char*)" diminished",       "C     D  D#    F  F#    G# A     B");
        fill((char*)" pentatonic",       "C     D     E        G     A      ");
        fill((char*)" pentatonic major", "C     D     E        G     A      ");
        fill((char*)" pentatonic minor", "C        Eb    F     G        Bb  ");
        fill((char*)" augmented",        "C        Eb E        G  Ab    Bb  ");
        fill((char*)" Lydian dominant",  "C     D     E     Gb G     A  Bb  ");
        fill((char*)" 3 semitone",       "C        D#       F#       A      ");
        fill((char*)" 4 semitone",       "C           E           G#        ");
        fill((char*)" blues",            "C     D  Eb    F  Gb G        Bb  ");
        fill((char*)" bebop",            "C     D     E  F     G     A  Bb B");
        // Major chords.
        fill((char*)"M",                 "C           E        G            ");
        fill((char*)"6",                 "C           E        G     A      ");
        fill((char*)"69",                "C     D     E        G     A      ");
        fill((char*)"69b5",              "C     D     E     Gb       A      ");
        fill((char*)"M7",                "C           E        G           B");
        fill((char*)"M9",                "C     D     E        G           B");
        fill((char*)"M11",               "C     D     E  F     G           B");
        fill((char*)"M13",               "C     D     E  F     G     A     B");
        // Minor chords.
        fill((char*)"m",                 "C        Eb          G            ");
        fill((char*)"m6",                "C        Eb          G     A      ");
        fill((char*)"m69",               "C     D  Eb          G     A      ");
        fill((char*)"m7",                "C        Eb          G        Bb  ");
        fill((char*)"m#7",               "C        Eb          G           B");
        fill((char*)"m7b5",              "C        Eb       Gb          Bb  ");
        fill((char*)"m9",                "C     D  Eb          G        Bb  ");
        fill((char*)"m9#7",              "C     D  Eb          G           B");
        fill((char*)"m11",               "C     D  Eb    F     G        Bb  ");
        fill((char*)"m13",               "C     D  Eb    F     G     A  Bb  ");
        // Augmented chords.
        fill((char*)"+",                 "C            E         G#         ");
        fill((char*)"7#5",               "C            E         G#     Bb  ");
        fill((char*)"7b9#5",             "C  Db        E         G#     Bb  ");
        fill((char*)"9#5",               "C     D      E         G#     Bb  ");
        // Diminished chords.
        fill((char*)"o",                 "C        Eb       Gb              ");
        fill((char*)"o7",                "C        Eb       Gb       A      ");
        // Suspended chords.
        fill((char*)"6sus",              "C              F     G     A      ");
        fill((char*)"69sus",             "C     D        F     G     A      ");
        fill((char*)"7sus",              "C              F     G        Bb  ");
        fill((char*)"9sus",              "C     D        F     G        Bb  ");
        fill((char*)"M7sus",             "C              F     G           B");
        fill((char*)"M9sus",             "C     D        F     G           B");
        // Dominant chords.
        fill((char*)"7",                 "C            E       G        Bb  ");
        fill((char*)"7b5",               "C            E    Gb          Bb  ");
        fill((char*)"7b9",               "C  Db        E       G        Bb  ");
        fill((char*)"7b9b5",             "C  Db        E    Gb          Bb  ");
        fill((char*)"9",                 "C     D      E       G        Bb  ");
        fill((char*)"11",                "C     D      E F     G        Bb  ");
        fill((char*)"13",                "C     D      E F     G     A  Bb  ");
