...
Test('''print CsoundAC.Voicelead_allVoicings([0, 4, 7], 0, 24, 12)''')
Test('''print CsoundAC.Voicelead_chordToPTV([1, 5, 8], 0, 24, 12)''')
Test('''print CsoundAC.Voicelead_allVoicings([7, 11, 14], 0, 24, 12)''')
...
Test('''print CsoundAC.Voicelead_allVoicings([0, 0, 0], 0, 24, 12)''')
...
Test('''print CsoundAC.Voicelead_allVoicings([0, 4, 7, 11], 0, 24, 12)''')
Test('''print CsoundAC.Voicelead_allVoicings([0, 4, 7, 11], 24, 60, 12)''')
Test('''print CsoundAC.Voicelead_allVoicings([2, 6, 9, 13], 24, 60, 12)''')
