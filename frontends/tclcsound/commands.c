...
*/
int csNote(ClientData clientData, Tcl_Interp * interp, int argc, char **argv)
{
    csdata *p = (csdata *) clientData;
    CSOUND *cs = p->instance;
    float   pFields[256];
...
*/
int csTable(ClientData clientData, Tcl_Interp * interp, int argc, char **argv)
{
    csdata *p = (csdata *) clientData;
    CSOUND *cs = p->instance;
    float   pFields[256];
...
int tclcsound_initialise(Tcl_Interp * interp)
{
    ...
    Tcl_CreateCommand(interp, "csStop", (Tcl_CmdProc *) csStop,
                      (ClientData) pdata, NULL);
    Tcl_CreateCommand(interp, "csNote", (Tcl_CmdProc *) csNote,
                      (ClientData) pdata, NULL);
    Tcl_CreateCommand(interp, "csTable", (Tcl_CmdProc *) csTable,
                      (ClientData) pdata, NULL);
    Tcl_CreateCommand(interp, "csRewind", (Tcl_CmdProc *) csRewind,
                      (ClientData) pdata, NULL);
    Tcl_CreateCommand(interp, "csOffset", (Tcl_CmdProc *) csOffset,
                      (ClientData) pdata, NULL);
    ...
    Tcl_CreateCommand(interp, "csInChannel", (Tcl_CmdProc *) csInChannel,
                      (ClientData) pdata, NULL);
    Tcl_CreateCommand(interp, "csOutValue", (Tcl_CmdProc *) csOutValue,
                      (ClientData) pdata, NULL);
    Tcl_CreateCommand(interp, "csInValue", (Tcl_CmdProc *) csInValue,
                      (ClientData) pdata, NULL);
