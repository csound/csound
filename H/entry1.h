...
int32_t tanh1 (CSOUND *, void *), log101 (CSOUND *, void *),
    log21 (CSOUND *, void *);
...
int32_t tanha (CSOUND *, void *), log10a (CSOUND *, void *),
    log2a (CSOUND *, void *);
...
int32_t kvar_out_on_set (CSOUND *, void *),
    kvar_out_on_set1 (CSOUND *, void *);
...
int32_t out_poly_aftertouch (CSOUND *, void *),
    out_progchange (CSOUND *, void *);
...
int32_t midinoteonpch (CSOUND *, void *),
    midipolyaftertouch (CSOUND *, void *);
...
int32_t presetctrl1_init (CSOUND *, void *),
    presetctrl1_perf (CSOUND *, void *);
int32_t selectctrl_init (CSOUND *, void *), selectctrl_perf (CSOUND *, void *);
int32_t printpresets_init (CSOUND *, void *),
    printpresets_init1 (CSOUND *, void *);
...
int32_t filebit (CSOUND *, void *);
int32_t filebit_S (CSOUND *, void *);
