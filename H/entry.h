...
int32_t mulin(CSOUND *, void *), mulina(CSOUND *, void *);
int32_t divin(CSOUND *, void *), divina(CSOUND *, void *);
int32_t mulinak(CSOUND *, void *), divinak(CSOUND *, void *);
...
int32_t pcount(CSOUND *, void*);
int32_t pvalue(CSOUND *, void*);
int32_t pvaluestr(CSOUND *, void*);
...
int32_t lpfil_deinit(CSOUND *csound, void *p);
int32_t lpfil2_deinit(CSOUND *csound, void *p);
int32_t lpred_deinit(CSOUND *csound, void *p);
int32_t lpred2_deinit(CSOUND *csound, void *p);
int32_t lpcpvs_deinit(CSOUND *csound, void *p);
int32_t pvscoefs_deinit(CSOUND *csound, void *p);
int32_t coef2parm_deinit(CSOUND *csound, void *p);
...
int32_t remove_all_events(CSOUND *csound, void *p);
int32_t type_of(CSOUND *csound, void *p);
int32_t check_type(CSOUND *csound, void *p);
