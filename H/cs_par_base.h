...
#define TRACE_0(...) csound->Message(csound, __VA_ARGS__)
#if TRACE > 0
    #define TRACE_1(...) csound->Message(csound, __VA_ARGS__)
#else
    #define TRACE_1(...)
#endif
#if TRACE > 1
    #define TRACE_2(...) csound->Message(csound, __VA_ARGS__)
#else
    #define TRACE_2(...)
#endif
#if TRACE > 2
    #define TRACE_3(...) csound->Message(csound, __VA_ARGS__)
#else
    #define TRACE_3(...)
#endif
#if TRACE > 3
    #define TRACE_4(...) csound->Message(csound, __VA_ARGS__)
#else
    #define TRACE_4(...)
#endif

/* #define SHARK_SYMBOLS */
...
#define BARRIER_2_WAIT_SYM 0x33
    ...
    #define SHARK_SIGNPOST(sym) syscall(SYS_kdebug_trace, \
                      APPSDBG_CODE(DBG_MACH_CHUD, sym) | DBG_FUNC_NONE, 0,0,0,0)
#else 
