...
typedef int (set_element_data_eq) (struct set_element_t *,
                                   struct set_element_t *);
...
/* allocating sets with specification of element equality and printing
 * functions */
...
/* call when all threads are done with the resource the semaphore is
 * protecting. releases all blocked threads. */
