...
When you hear dropouts, end the performance with Ctrl-C.
Performance is then measured by how many instances 
...
p3, aleft, aright	    Declick			        0.003, p3, .05, aleft, aright
                        ...
                        instr 51                ; Modeled Guitar, Jeff Livingston
                        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
aleft, aright		    Pan			            p7, asig
                        ...
                        instr 52                ; Epicycloid or Spirograph curve, Mikelson TODO: Find better parameters?
                        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
p3, aleft, aright	    Declick			        0.003, p3, .05, aleft, aright
                        ...
                        instr 53                ; Hypocycloid or Spirograph curve, Mikelson
                        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                        ; This set of parametric equations defines the path traced by
...
p3, aleft, aright	    Declick			        0.003, p3, .05, aleft, aright
                        ...
                        instr 54                ; Banchoff Klein Bottle, Mikelson
                        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
p3, aleft, aright	    Declick			        0.003, p3, .05, aleft, aright
                        ...
                        instr 55                ; Low-level plucked string, Comajuncosas TODO: Fix this.
                        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;tricky but easy...
                        ...
                        instr 56                ; Bass Physical Model, Mikelson
                        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                        ; p1  p2     p3   p4    p5     p6
...
p3, aleft, aright	    Declick			        0.003, p3, .05, aleft, aright
                        ...
                        instr 59                ; Basic Granular Synthesis, Mikelson
                        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
p3, aleft, aright	    Declick			        0.003, p3, .05, aleft, aright
                        ...
                        instr 60                ; Chebyshev Waveshaping Drone, Michael Gogins
                        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                        ;   p1      p2      p3          p4              p5         p6           p7        p8
...
p3, aleft, aright	    Declick			        iattack, p3, irelease, aleft, aright
                        ...
                        instr 61                ; Reverb Sine, Michael Gogins
                        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                        pset                    0, 0, 3600, 0, 0, 0, 0, 0, 0, 0, 0
iHz,kHz,iamplitude,idB  NoteOn                  p4, p5, 8.5
iattack 		        = 			            0.02
...
p3, aleft, aright	    Declick			        0.003, p3, .05, aleft, aright
                        ...
                        instr 62                ; Reverb Sine 2, Michael Gogins
                        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                        pset                    0, 0, 3600, 0, 0, 0, 0, 0, 0, 0, 0
...
p3, aleft, aright	    Declick			        iattack, isustain, idecay, aleft, aright
                        ...
                        instr 63                ; FM with reverberated modulator, Michael Gogins
                        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                        pset                    0, 0, 3600, 0, 0, 0, 0, 0, 0, 0, 0
iHz,kHz,iamplitude,idB  NoteOn                  p4, p5, 0
iattack			        =			            0.004
...
'''
    ...
    def createScore(self):
        ...
        time_ = 0.0
        for i in xrange(250):
            instrument = int(2.0 + ((i * 19.7) % 104.2) % 62.0)
...
if len(sys.argv) > 1:
    ...
    csoundComposition.renderingMode = 'audio'
