...
csound.setCommand("csound -RWdo ./temp.wav -d ./temp.orc ./temp.sco")
csound.setOrchestra('''
sr = 44100
kr = 2940
ksmps = 15   
...
kdampingr 		linsegr			0.0, iattack, 1.0, isustain, 1.0, irelease, 0.0
ip4 			= 				p5
iamp 			= 				(ip4 + 36) - (p4 * 4)
...
k1 				line 			40, p3, 800
k2 				line 			440, p3, 220
k3 				linenr 			isc, ip6, p3, ip7
k4 				line 			800, ip3,40
k5 				line 			220, ip3,440
k6 				linenr 			isc, ip6, ip3, ip7
k7 				linenr 			1, ip6, ip3, ip7
; AUDIO
...
a18 			= 				(a16 + a4) * irightgain * k7
				outs 			a17 * kdamping * kdampingr, a18 * kdamping * kdampingr
endin
...
ijunk11 		= 				p11
; AUDIO
adecay 			expsegr 		0.001, iattack, 1.001, 6.0, 0.001, isustain, 0.001
kdamping 		linseg			0.0, iattack, 1.0, isustain, 1.0, irelease, 0.0
...
kenvelope0 		expsegr 		1.0, iattack, 2.0, idecay, 1.3, isustain, 1.1, irelease, 1.0
...
; KONTROL
kdamping 		linseg		0.0, iattack, 1.0, idecay + isustain, 1.0, irelease, 0.0
kenvelope0 		expsegr 	1.0, iattack, 2.0, idecay, 1.4, isustain, 1.2, irelease, 1.0
kenvelope 		= 	 			kenvelope0 - 1.0
kindex 			= 	 			index + (kenvelope * ifmamplitude)
; AUDIO
imodulator 		= 	 			.01
...
ioct 			= 			p4
; KONTROL
kadsr 			linsegr 		0, iattack, 1, isustain, 1, irelease, 0
kmodi 			linsegr 		0, iattack, 5, isustain, 3, irelease, 0
...
; AUDIO
aenv1 			expsegr 		0.000001, iattack, 1.0, 15.0, 0.000001
