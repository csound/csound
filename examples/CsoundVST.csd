<CsoundSynthesizer>
<CsOptions>
-f -M0 -+rtaudio=PortAudio -m7 --midi-key=4 --midi-velocity=5 -odac0
</CsOptions>
<CsInstruments>
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
iamplitude 		= 			ampdb(ivelocity) * (inormal / imeasure)
                        print                   ikey, ifrequency, iamplitude
...
ileftgain               =                       sqrt(2.0) / 2.0 * (cos(itheta) - sin(itheta))
			...
			opcode			Declick, aa, iiaa
			;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
iatt,irel,a1,a2		xin
                        if (p3 > 0)             then
isustain		= 			p3
p3			=			iatt + isustain + irel                        
                        else
isustain                =                       100000
                        endif                        
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
			...
			;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                        pset                    0, 0, -1, 60, 80, 0, 0, 0, 0, 0, 0
ifrequency,iamplitude	NoteOn                  p4, p5, 1500000
adamping		Damping			.003, .1
ishift			=           		8./1200.
...
ad1         		deltap      		0.07                     	; delay 100 msec.
ad2         		deltap      		0.105                    	; delay 200 msec.
...
aleft, aright		Declick			.005, 0.3, aleft, aright
			AssignSend		0., 0.,  .2, 1
			SendOut			aleft, aright
			endin
...
aleft, aright		Pan			asignal * iamplitude * aenvelope
aleft, aright		Declick			.01, 0.3, aleft, aright
			AssignSend		0., 0.,  .4, 1
			SendOut			aleft, aright
			endin
...
isustain		=			p3
irelease 		= 			0.3333333
adamping		Damping			iattack,irelease
ip6                     =                       0.3
ip7                     =                       2.2
ishift      		=           		4./12000.
ipch       		=           		ifrequency
...
aleft, aright		Declick			.25, .5, aleft, aright
			AssignSend		.2, 0.,  .2, 1
			SendOut			aleft, aright
			endin
...
aleft, aright		Declick			.15, .25, aleft, aright
			AssignSend		0., 0.,  .2, 1.0
			SendOut			aleft, aright
			endin
...
aleft, aright		Declick			iattack, irelease, aleft, aright
			AssignSend		0., 0., .2, 1.0
			SendOut			aleft, aright
			endin
...
aleft, aright		Pan			asignal * iamplitude
aleft, aright		Declick			.005, .05, aleft, aright
			AssignSend		0., 0.,  .2, 1
			SendOut			aleft, aright
			endin
...
aleft, aright		Pan			asignal
aleft, aright		Declick			.003, .05, aleft, aright
			AssignSend		.2, 0.,  .2, 1
			SendOut			aleft, aright
			endin
...
aleft, aright		Pan			asignal
aleft, aright		Declick			.003, .5, aleft, aright
			AssignSend		0., 0., .1, 1.0
			SendOut			aleft, aright
			endin
...
aleft, aright		Pan			asignal * iamplitude
aleft, aright		Declick			.006, .05, aleft, aright
			AssignSend		0., 0., .2, 1.0
			SendOut			aleft, aright
			endin
...
aleft, aright		Pan			asignal * adamping
			AssignSend		.0, 0., 0.2, 1.2
			SendOut			aleft, aright
			endin
