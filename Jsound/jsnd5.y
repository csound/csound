...
gident		  : T_IDENT_GI          { $$ = make_leaf(T_IDENT_GI, yylval); }
		  ...
		  | T_IDENT_GF          { $$ = make_leaf(T_IDENT_GF, yylval); }
		  | T_IDENT_GW          { $$ = make_leaf(T_IDENT_GW, yylval); }
		  | T_IDENT_GS          { $$ = make_leaf(T_IDENT_GS, yylval); }
...
ident		  : T_IDENT_I           { $$ = make_leaf(T_IDENT_I, yylval); }
		  ...
		  | T_IDENT_F           { $$ = make_leaf(T_IDENT_F, yylval); }
		  | T_IDENT_W           { $$ = make_leaf(T_IDENT_W, yylval); }
...
opcode0           : T_OPCODE0           { printf("opcode0 yylval=%p\n", yylval);
                                          $$ = make_leaf(T_OPCODE0, yylval); }
		  ;
