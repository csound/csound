...
def run_clang_format_diff(args, file):
    ...
    # Hlöðver: implicitly setting the style here
    # since .clang-format dotfile isn't supported
    # on older clang versions
    invocation.extend(['--style', '{BasedOnStyle: Chromium, Standard: Cpp11}'])
