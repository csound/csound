...
#define VERSION "@CSOUND_VERSION_MAJOR@.@CSOUND_VERSION_MINOR@"
...
#define CS_VERSION          (@CSOUND_VERSION_MAJOR@)
#define CS_SUBVER           (@CSOUND_VERSION_MINOR@)
#define CS_PATCHLEVEL       (@CSOUND_VERSION_PATCH@)
