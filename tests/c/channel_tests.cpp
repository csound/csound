...
TEST (ChannelTests, ControlChannel)
{
    csoundSetGlobalEnv("OPCODE6DIR64", "../../");
...
TEST (ChannelTests, ChannelCallbacks)
{
    csoundSetGlobalEnv("OPCODE6DIR64", "../../");
    CSOUND *csound = csoundCreate(0);
    csoundCreateMessageBuffer(csound, 0);
...
TEST (ChannelTests, ChannelOpcodes)
{
    csoundSetGlobalEnv("OPCODE6DIR64", "../../");
    CSOUND *csound = csoundCreate(0);
    csoundCreateMessageBuffer(csound, 0);
...
TEST (ChannelTests, InvalidChannel)
{
    csoundSetGlobalEnv("OPCODE6DIR64", "../../");
    CSOUND *csound = csoundCreate(0);
    csoundCreateMessageBuffer(csound, 0);
...
TEST (ChannelTests, StringChannel)
{
