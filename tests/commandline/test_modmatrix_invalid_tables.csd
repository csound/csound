<CsTest>
description = "reject invalid modmatrix dimensions and table sizes"

[expect]
exit = "nonzero"
stderr = ["modmatrix: number of modulators must be a positive integer", "modmatrix: number of parameters must be a positive integer", "modmatrix: modulator table is too short", "modmatrix: parameter or result table is too short", "modmatrix: routing matrix table is too short"]
</CsTest>
<CsoundSynthesizer>
<CsOptions>
-n -d -m0
