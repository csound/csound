...
/** Set value for output argument for opcode's data struct by index. Assumes
 * UGEN arguments are not set by reference.
 *
 * TODO - consider using CS_VARIABLE instead of void* so that
...
/** Set value for input argument for opcode's data struct by index. Assumes
 * UGEN arguments are not set by reference.
 *
 * TODO - consider using CS_VARIABLE instead of void* so that
 * type check can happen here.
