...
#define CS_ARG_TYPE_OUT 2
  ...
  typedef struct cstype
  {
    ...
    void (*copyValue) (CSOUND *csound, struct cstype *cstype, void *dest,
                       void *src);
...
#define CS_VAR_TYPE_OFFSET (sizeof (CS_VAR_MEM) - sizeof (MYFLT))
  ...
  PUBLIC CS_VARIABLE *csoundCreateVariable (CSOUND *csound, TYPE_POOL *pool,
                                            ...
                                            void *typeArg);
  PUBLIC CS_TYPE *csoundGetTypeWithVarTypeName (TYPE_POOL *pool,
                                                char *typeName);
  ...
  PUBLIC void initializeVarPool (CSOUND *csound, MYFLT *memBlock,
                                 CS_VAR_POOL *pool);
