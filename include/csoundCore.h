...
#define ASYNC_LOCAL 2
  ...
  */
  ...
  typedef struct text
  {
    ...
    //    char            intype;         /* Type of first input argument
    //    (g,k,a,w etc) */
...
#define MAX_STRINGDAT_SIZE 0xFFFFFFFF
  ...
  typedef struct event
  {
    ...
    MYFLT p[PMAX + 1];
    union
    { /* To ensure size is same as earlier */
      MYFLT *extra;
      MYFLT p[2];
    } c;
  } EVTBLK;
...
#define MAX_INCLUDE_DEPTH 100
  ...
  typedef struct in_stack_s
  {                         /* Stack of active inputs */
...
#include "find_opcode.h"
  ...
  struct CSOUND_
  {
    ...
    int (*CreateConfigurationVariable) (CSOUND *, const char *name, void *p,
                                        int type, int flags, void *min,
    ...
    int (*ParseConfigurationVariable) (CSOUND *, const char *name,
                                       const char *value);
    csCfgVariable_t *(*QueryConfigurationVariable) (CSOUND *,
                                                    const char *name);
    ...
    /**@{ */
    void *(*CreateThread) (uintptr_t (*threadRoutine) (void *),
                           void *userdata);
    ...
    /** @name File access */
    /**@{ */
    char *(*FindInputFile) (CSOUND *, const char *filename,
                            const char *envList);
  ...
  char *(*LocalizeString) (const char *)__attribute__ ((format_arg (1)));
    ...
    int (*AuxAllocAsync) (CSOUND *, size_t, AUXCH *, AUXASYNC *, aux_cb,
                          void *);
    ...
    /**@}*/
    /** @name Placeholders
        To allow the API to grow while maintining backward binary
       compatibility. */
    /**@{ */
    SUBR dummyfn_2[13];
    /**@}*/
    ...
    /** @name Private Data
      ...
      internally by the library), use the CreateGlobalVariable() etc.
      interface, instead of adding to CSOUND.
