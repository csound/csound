...
{
    // Called when the plugin opcode is unloaded, usually when Csound
terminates. return 0;
}
...
#define LINKAGE                                                               \
  ...
  /** The LINKAGE_BUILTIN macro sets up linking of opcode list for builtin
   * opcodes which must have unique function names */
