; C S O U N D   7   I N N O   S E T U P   S C R I P T   ( 3 2 - b i t )
;
...
;     plugins (all Csound plugin opcodes)
;     samples (copy tree)
;
...
AppId={{A85C3F2D-7B4E-4E9A-8C1F-5D6E9F8A3B2C}}
AppName={#AppName}
...
#define APP_PLUGINS "{app}\plugins\"
...
; vc_redist.x86.exe is staged to {tmp} and executed in [Run].
Source: "installer\windows\vc_redist.x86.exe"; DestDir: "{tmp}"; Flags: deleteafterinstall; Components: core
...
Source: "{#ReleaseDir}\osc.dll"; DestDir: "{#APP_PLUGINS}"; Flags: ignoreversion; Components: core;
...
Source: "{#ReleaseDir}\pmidi.dll"; DestDir: "{#APP_PLUGINS}"; Flags: ignoreversion; Components: core;
Source: "{#ReleaseDir}\rtpa.dll"; DestDir: "{#APP_PLUGINS}"; Flags: ignoreversion skipifsourcedoesntexist; Components: core;
Source: "{#ReleaseDir}\rtwinmm.dll"; DestDir: "{#APP_PLUGINS}"; Flags: ignoreversion; Components: core;
...
Source: "{#ReleaseDir}\deprecated.dll"; DestDir: "{#APP_PLUGINS}"; Flags: ignoreversion; Components: core;
Source: "{#ReleaseDir}\stdutil.dll"; DestDir: "{#APP_PLUGINS}"; Flags: ignoreversion; Components: core;
