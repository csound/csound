...
headerFiles += ['H/msg_attr.h', 'H/OpcodeBase.hpp', 'H/pstream.h']
headerFiles += ['H/pvfileio.h', 'H/soundio.h', 'H/sysdep.h', 'H/text.h']
headerFiles += ['H/version.h']
...
docFiles = ['COPYING', 'ChangeLog', 'readme-csound5.txt']
