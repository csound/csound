...
public class CsoundEditor extends JFrame {
			...
			jButton3.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					try {
						...
						Runtime.getRuntime().exec(soundfilePlayer + " " 
	...
	public CsoundEditor() {
		super();
		try {
		properties.load(new java.io.FileInputStream("CsoundEditor.properties"));
		} catch (Exception x) {
			x.printStackTrace();
		}
		soundfilePlayer = properties.getProperty("SoundfilePlayer", soundfilePlayer);
		initialize();
	}
