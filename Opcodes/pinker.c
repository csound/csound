/*
    ...
    Terms of use:
    Use for any purpose. If used in a commercial product, you should give me
   one.
    - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
#define FA(n)                                                                  \
  F(1.190566, n, 0) + F(0.162580, n, 1) + F(0.002208, n, 2) +                  \
      F(0.025475, n, 3) + F(-0.001522, n, 4) + F(0.007322, n, 5) - PINK_BIAS
#define FB(n)                                                                  \
  F(0.001774, n, 0) + F(0.004529, n, 1) + F(-0.001561, n, 2) +                 \
...
static const unsigned char pnmask[256] = {
    PM16(0x00), PM16(0x08), PM16(0x04), PM16(0x08), PM16(0x02), PM16(0x08),
    PM16(0x04), PM16(0x08), PM16(0x01), PM16(0x08), PM16(0x04), PM16(0x08),
    PM16(0x02), PM16(0x08), PM16(0x04), PM16(0x08)};

static const int ind[] = {0,      0x0800, 0x0400, 0x0800, 0x0200, 0x0800,
                          0x0400, 0x0800, 0x0100, 0x0800, 0x0400, 0x0800,
...
static int pink_perf(CSOUND *csound, PINKER *p) {
  ...
  for (n = offset, nn = loffset; n < nsmps; n++, nn++) {
    ...
    /* leftOut[i+1] = accu * pscale + pflta[lfsr & 0x3F] + pfltb[lfsr >> 6 &
     * 0x3F]; */
...
static OENTRY pinker_localops[] = {{"pinker", sizeof(PINKER), 0, 3, "a", "",
                                    (SUBR)pink_init, (SUBR)pink_perf}};
