...
#define ROOT2 FL(1.41421356237309504880168872421)
    ...
    static int padsynth_gen (FGDATA *ff, FUNC *ftp)
    {
        ...
        // The algorithm computes a spectrum based on the partials and their bandwidths.
        ...
        for (int partialI = 1; partialI <= partialN; ++partialI) {
            ...
            bw_Hz = (std::pow(2.0, p6_partial_bandwith / 1200.0) - 1.0) * p5_fundamental_frequency * std::pow(p8_harmonic_stretch * partialI, p7_partial_bandwidth_scale_factor);
