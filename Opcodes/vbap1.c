...
#include "csoundCore.h"  // for CSOUND_, OK, AUXCH, ARRAYDAT, CS_EKR, CS_ONEDKR
#include "sysdep.h"      // for FL, MYFLT, UNLIKELY, int32, LIKELY, SQRT
#include "vbap.h"        // for VBAP1_MOVE_DATA, CART_VEC, VBAP1_DATA, vec_mean
