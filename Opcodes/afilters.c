...
static int32_t atonexa(CSOUND *csound,
                       TONEX *p) /* Gabriel Maldonado, modified */
{
  MYFLT *ar = p->ar;
  double c2 = p->c2, *yt1 = p->yt1;
  uint32_t offset = p->h.insdshead->ksmps_offset;
...
static OENTRY afilts_localops[] = {
    {"areson.aa", sizeof(RESON), 0, 3, "a", "aaaoo", (SUBR)arsnset,
     (SUBR)aresonaa},
    {"areson.ak", sizeof(RESON), 0, 3, "a", "aakoo", (SUBR)arsnset,
     (SUBR)aresonak},
    {"areson.ka", sizeof(RESON), 0, 3, "a", "akaoo", (SUBR)arsnset,
     (SUBR)aresonka},
    {"atone.a", sizeof(TONE), 0, 3, "a", "ako", (SUBR)atonset, (SUBR)atonea},
    {"atonex.a", sizeof(TONEX), 0, 3, "a", "aaoo", (SUBR)atonsetx,
     (SUBR)atonexa},
    ...
    {"butterbp", sizeof(BBFIL), 0, 3, "a", "axxo", (SUBR)bbutset,
     (SUBR)bppasxx},
    {"butbp", sizeof(BBFIL), 0, 3, "a", "axxo", (SUBR)bbutset, (SUBR)bppasxx},
    {"butterbr", sizeof(BBFIL), 0, 3, "a", "axxo", (SUBR)bbutset,
     (SUBR)bpcutxx},
