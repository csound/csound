...
static OENTRY image_localops[] = {
  ...
  { "imagegetpixel",  S(IMGGETPIXEL),  0, 5, "aaa", "ixx",
    (SUBR)imagegetpixel, NULL, (SUBR)imagegetpixel_a                           },
  { "imagesetpixel",  S(IMGSETPIXEL),  0, 3, "", "ikkkkk",
    (SUBR)imagesetpixel, (SUBR)imagesetpixel, (SUBR)imagesetpixel_a            },
  { "imagesetpixel",  S(IMGSETPIXEL),  0, 5, "", "iaaaaa",
    (SUBR)imagesetpixel, NULL, (SUBR)imagesetpixel_a                          },
