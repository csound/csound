...
{ "spectrum", S(SPECTRUM),_QQ|7, "w", "siiiqoooo",
...
{ "transegb", S(TRANSEG), 7,  "s", "iiim",
                              (SUBR)trnset_bkpt,(SUBR)ktrnseg,(SUBR)trnseg    },
{ "transegr", S(TRANSEG), 7, "s", "iiim",
                              (SUBR)trnsetr,(SUBR)ktrnsegr,(SUBR)trnsegr      },
{ "clip", S(CLIP),       5,  "a", "aiiv", (SUBR)clip_set, NULL, (SUBR)clip  },
{ "cpuprc", S(CPU_PERC), 1,     "",     "Ti",   (SUBR)cpuperc, NULL, NULL   },
{ "maxalloc", S(CPU_PERC), 1,   "",     "Ti",   (SUBR)maxalloc, NULL, NULL  },
{ "active", 0xffff                                                          },
{ "active.i", S(INSTCNT),1,     "i",    "Too",   (SUBR)instcount, NULL, NULL },
{ "active.k", S(INSTCNT),2,     "k",    "Uoo",   NULL, (SUBR)instcount, NULL },
