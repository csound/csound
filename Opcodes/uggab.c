...
{ "duserrnd.a", S(DURAND),0,4, "a", "k",
                                (SUBR)Cuserrnd_set,NULL,(SUBR)aDiscreteUserRand },
//{ "poscil", 0xfffe, TR                                                          },
{ "poscil.a", S(POSC), TR,5, "a", "kkjo", (SUBR)posc_set,(SUBR)NULL,(SUBR)posckk },
{ "poscil.kk", S(POSC), TR,3, "k", "kkjo", (SUBR)posc_set,(SUBR)kposc,NULL },
{ "poscil.ka", S(POSC), TR,5, "a", "kajo", (SUBR)posc_set, NULL,  (SUBR)poscka },
{ "poscil.ak", S(POSC), TR,5, "a", "akjo", (SUBR)posc_set, NULL,  (SUBR)poscak },
{ "poscil.aa", S(POSC), TR,5, "a", "aajo", (SUBR)posc_set, NULL,  (SUBR)poscaa },
{ "lposcil",  S(LPOSC), TR, 5, "a", "kkkkjo", (SUBR)lposc_set, NULL, (SUBR)lposc},
//{ "poscil3", 0xfffe, TR                                                     },
{ "poscil3.a",S(POSC), TR,5, "a", "kkjo",
                                     (SUBR)posc_set,(SUBR)NULL,(SUBR)posc3kk },
{ "poscil3.kk",S(POSC), TR,3, "k", "kkjo",
                                     (SUBR)posc_set,(SUBR)kposc3,NULL},
{ "poscil3.ak", S(POSC), TR,5, "a", "akjo", (SUBR)posc_set, NULL, (SUBR)posc3ak },
{ "poscil3.ka", S(POSC), TR,5, "a", "kajo", (SUBR)posc_set, NULL, (SUBR)posc3ka },
{ "poscil3.aa", S(POSC), TR,5, "a", "aajo", (SUBR)posc_set, NULL, (SUBR)posc3aa },
