...
static int32_t lposc_set(CSOUND *csound, LPOSC *p)
{
    ...
    if (UNLIKELY(!(p->fsr=ftp->gen01args.sample_rate))) {
      csound->Warning(csound, "%s", Str("losc: no sample rate stored in function "
                                  "assuming=sr\n"));
      p->fsr=CS_ESR;
    }
    p->ftp    = ftp;
...
{ "duserrnd.a", S(DURAND),0, "a", "k",
                                (SUBR)Cuserrnd_set,(SUBR)aDiscreteUserRand },
//{ "poscil", 0xfffe, TR                                                          },
{ "poscil.a", S(POSC), TR, "a", "kkjo", (SUBR)posc_set,(SUBR)posckk },
{ "poscil.kk", S(POSC), TR, "k", "kkjo", (SUBR)posc_set,(SUBR)kposc,NULL },
{ "poscil.ka", S(POSC), TR, "a", "kajo", (SUBR)posc_set,  (SUBR)poscka },
{ "poscil.ak", S(POSC), TR, "a", "akjo", (SUBR)posc_set,  (SUBR)poscak },
{ "poscil.aa", S(POSC), TR, "a", "aajo", (SUBR)posc_set,  (SUBR)poscaa },
{ "lposcil",  S(LPOSC), TR, "a", "kkkkjo", (SUBR)lposc_set, (SUBR)lposc},
//{ "poscil3", 0xfffe, TR                                                     },
{ "poscil3.a",S(POSC), TR, "a", "kkjo",
                                     (SUBR)posc_set,(SUBR)posc3kk },
{ "poscil3.kk",S(POSC), TR, "k", "kkjo",
                                     (SUBR)posc_set,(SUBR)kposc3,NULL},
{ "poscil3.ak", S(POSC), TR, "a", "akjo", (SUBR)posc_set, (SUBR)posc3ak },
{ "poscil3.ka", S(POSC), TR, "a", "kajo", (SUBR)posc_set, (SUBR)posc3ka },
{ "poscil3.aa", S(POSC), TR, "a", "aajo", (SUBR)posc_set, (SUBR)posc3aa },
