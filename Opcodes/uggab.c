...
{ "duserrnd.a", S(DURAND),0,4, "a", "k",
                                (SUBR)Cuserrnd_set,NULL,(SUBR)aDiscreteUserRand },
{ "poscil", 0xfffe, TR                                                          },
{ "poscil.kk", S(POSC), 0,7, "s", "kkio", (SUBR)posc_set,(SUBR)kposc,(SUBR)posckk },
{ "poscil.ka", S(POSC), 0,5, "a", "kaio", (SUBR)posc_set, NULL,  (SUBR)poscka },
{ "poscil.ak", S(POSC), 0,5, "a", "akio", (SUBR)posc_set, NULL,  (SUBR)poscak },
