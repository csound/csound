...
static OENTRY oentries[] = {
    ...
    {(char *)"outleta", sizeof(Outleta), _CW, 5, (char *)"", (char *)"Sa",
     (SUBR)&Outleta::init_, 0, (SUBR)&Outleta::audio_},
    {(char *)"inleta", sizeof(Inleta), _CR, 5, (char *)"a", (char *)"S",
     (SUBR)&Inleta::init_, 0, (SUBR)&Inleta::audio_},
    ...
    {(char *)"inletkid", sizeof(Inletkid), _CR, 3, (char *)"k", (char *)"SS",
     (SUBR)&Inletk::init_, (SUBR)&Inletk::kontrol_, 0},
    {(char *)"outletf", sizeof(Outletf), _CW, 5, (char *)"", (char *)"Sf",
     (SUBR)&Outletf::init_, 0, (SUBR)&Outletf::audio_},
    {(char *)"inletf", sizeof(Inletf), _CR, 5, (char *)"f", (char *)"S",
     (SUBR)&Inletf::init_, 0, (SUBR)&Inletf::audio_},
    {(char *)"outletv", sizeof(Outletv), _CW, 5, (char *)"", (char *)"Sa[]",
     (SUBR)&Outletv::init_, 0, (SUBR)&Outletv::audio_},
    {(char *)"inletv", sizeof(Inletv), _CR, 5, (char *)"a[]", (char *)"S",
     (SUBR)&Inletv::init_, 0, (SUBR)&Inletv::audio_},
