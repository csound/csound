...
static OENTRY crossfm_localops[] = {
    ...
    {"crossfmi", S(CROSSFM), TR, 3, "aa", "xxxxkiioo", (SUBR)xfmset,
     (SUBR)xfmi},
    {"crosspm", S(CROSSFM), TR, 3, "aa", "xxxxkiioo", (SUBR)xfmset, (SUBR)xpm},
    {"crosspmi", S(CROSSFM), TR, 3, "aa", "xxxxkiioo", (SUBR)xfmset,
     (SUBR)xpmi},
    {"crossfmpm", S(CROSSFM), TR, 3, "aa", "xxxxkiioo", (SUBR)xfmset,
     (SUBR)xfmpm},
    {"crossfmpmi", S(CROSSFM), TR, 3, "aa", "xxxxkiioo", (SUBR)xfmset,
     (SUBR)xfmpmi},
};
