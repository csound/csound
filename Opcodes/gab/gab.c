...
/* { "zr_i",  S(ZKR),     0,   "i",  "i",  (SUBR)zread, NULL, NULL}, */
/* { "zr_k",  S(ZKR),     0,   "k",  "k",  NULL, (SUBR)zread, NULL}, */
/* { "zr_a",  S(ZAR),     0,   "a",  "a",  (SUBR)zaset, (SUBR)zar}, */
/* { "k_i",   S(ASSIGN),  0,   "k",  "i",  (SUBR)assign}, */
/* { "k_t",   S(ASSIGN),  0,   "k",  "t",  NULL, (SUBR)assign}, */
/* { "a_k",   S(INDIFF),  0,   "a",  "k",  (SUBR)a_k_set, (SUBR)interp }, */
