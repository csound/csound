...
OENTRY gab_localops[] = {
  ...
  { "tb0_init", S(TB_INIT),  0, 1,   "",      "i",    (SUBR)tab0_init},
  { "tb1_init", S(TB_INIT),  0, 1,   "",      "i",    (SUBR)tab1_init},
  { "tb2_init", S(TB_INIT),  0, 1,   "",      "i",    (SUBR)tab2_init},
  { "tb3_init", S(TB_INIT),  0, 1,   "",      "i",    (SUBR)tab3_init},
  { "tb4_init", S(TB_INIT),  0, 1,   "",      "i",    (SUBR)tab4_init},
  { "tb5_init", S(TB_INIT),  0, 1,   "",      "i",    (SUBR)tab5_init},
  { "tb6_init", S(TB_INIT),  0, 1,   "",      "i",    (SUBR)tab6_init},
  { "tb7_init", S(TB_INIT),  0, 1,   "",      "i",    (SUBR)tab7_init},
  { "tb8_init", S(TB_INIT),  0, 1,   "",      "i",    (SUBR)tab8_init},
  { "tb9_init", S(TB_INIT),  0, 1,   "",      "i",    (SUBR)tab9_init},
  { "tb10_init", S(TB_INIT), 0, 1,   "",      "i",    (SUBR)tab10_init},
  { "tb11_init", S(TB_INIT), 0, 1,   "",      "i",    (SUBR)tab11_init},
  { "tb12_init", S(TB_INIT), 0, 1,   "",      "i",    (SUBR)tab12_init},
  { "tb13_init", S(TB_INIT), 0, 1,   "",      "i",    (SUBR)tab13_init},
  { "tb14_init", S(TB_INIT), 0, 1,   "",      "i",    (SUBR)tab14_init},
  { "tb15_init", S(TB_INIT), 0, 1,   "",      "i",    (SUBR)tab15_init},
  /* tbx_t (t-rate version removed here) */
  { "tb0.i",      S(FASTB), TR, 1,    "i",     "i",    (SUBR) tab0_i_tmp    },
  { "tb1.i",      S(FASTB), TR, 1,    "i",     "i",    (SUBR) tab1_i_tmp    },
  { "tb2.i",      S(FASTB), TR, 1,    "i",     "i",    (SUBR) tab2_i_tmp    },
  { "tb3.i",      S(FASTB), TR, 1,    "i",     "i",    (SUBR) tab3_i_tmp    },
  { "tb4.i",      S(FASTB), TR, 1,    "i",     "i",    (SUBR) tab4_i_tmp    },
  { "tb5.i",      S(FASTB), TR, 1,    "i",     "i",    (SUBR) tab5_i_tmp    },
  { "tb6.i",      S(FASTB), TR, 1,    "i",     "i",    (SUBR) tab6_i_tmp    },
  { "tb7.i",      S(FASTB), TR, 1,    "i",     "i",    (SUBR) tab7_i_tmp    },
  { "tb8.i",      S(FASTB), TR, 1,    "i",     "i",    (SUBR) tab8_i_tmp    },
  { "tb9.i",      S(FASTB), TR, 1,    "i",     "i",    (SUBR) tab9_i_tmp    },
  { "tb10.i",     S(FASTB), TR, 1,    "i",     "i",    (SUBR) tab10_i_tmp   },
  { "tb11.i",     S(FASTB), TR, 1,    "i",     "i",    (SUBR) tab11_i_tmp   },
  { "tb12.i",     S(FASTB), TR, 1,    "i",     "i",    (SUBR) tab12_i_tmp   },
  { "tb13.i",     S(FASTB), TR, 1,    "i",     "i",    (SUBR) tab13_i_tmp   },
  { "tb14.i",     S(FASTB), TR, 1,    "i",     "i",    (SUBR) tab14_i_tmp   },
  { "tb15.i",     S(FASTB), TR, 1,    "i",     "i",    (SUBR) tab15_i_tmp   },
  { "tb0.k",  S(FASTB), TR, 2,  "k",    "k",    NULL, (SUBR) tab0_k_tmp,  NULL  },
  { "tb1.k",  S(FASTB), TR, 2,  "k",    "k",    NULL, (SUBR) tab1_k_tmp,  NULL  },
  { "tb2.k",  S(FASTB), TR, 2,  "k",    "k",    NULL, (SUBR) tab2_k_tmp,  NULL  },
  { "tb3.k",  S(FASTB), TR, 2,  "k",    "k",    NULL, (SUBR) tab3_k_tmp,  NULL  },
  { "tb4.k",  S(FASTB), TR, 2,  "k",    "k",    NULL, (SUBR) tab4_k_tmp,  NULL  },
  { "tb5.k",  S(FASTB), TR, 2,  "k",    "k",    NULL, (SUBR) tab5_k_tmp,  NULL  },
  { "tb6.k",  S(FASTB), TR, 2,  "k",    "k",    NULL, (SUBR) tab6_k_tmp,  NULL  },
  { "tb7.k",  S(FASTB), TR, 2,  "k",    "k",    NULL, (SUBR) tab7_k_tmp,  NULL  },
  { "tb8.k",  S(FASTB), TR, 2,  "k",    "k",    NULL, (SUBR) tab8_k_tmp,  NULL  },
  { "tb9.k",  S(FASTB), TR, 2,  "k",    "k",    NULL, (SUBR) tab9_k_tmp,  NULL  },
  { "tb10.k", S(FASTB), TR, 2,  "k",    "k",    NULL, (SUBR) tab10_k_tmp, NULL  },
  { "tb11.k", S(FASTB), TR, 2,  "k",    "k",    NULL, (SUBR) tab11_k_tmp, NULL  },
  { "tb12.k", S(FASTB), TR, 2,  "k",    "k",    NULL, (SUBR) tab12_k_tmp, NULL  },
  { "tb13.k", S(FASTB), TR, 2,  "k",    "k",    NULL, (SUBR) tab13_k_tmp, NULL  },
  { "tb14.k", S(FASTB), TR, 2,  "k",    "k",    NULL, (SUBR) tab14_k_tmp, NULL  },
  { "tb15.k", S(FASTB), TR, 2,  "k",    "k",    NULL, (SUBR) tab15_k_tmp, NULL  },
