...
static int32_t atabmorphia(CSOUND *csound,
                           TABMORPH *p) /* all arguments at a-rate */
{
  IGN(csound);
  ...
  for (n = offset; n < nsmps; n++) {
    ...
    MYFLT val1a, val2a, val1b, val2b, tab1val1b, tab1val2b, tab2val1b,
        tab2val2b;
    int64_t index_int;
    int32_t tabndx1int, tabndx2int;
...
OENTRY tabmoroph_localops[] = {
    ...
    {"tabmorph", S(TABMORPH), TR, 3, "k", "kkkkm", (SUBR)tabmorph_set,
     (SUBR)tabmorph, NULL},
    {"tabmorphi", S(TABMORPH), TR, 3, "k", "kkkkm", (SUBR)tabmorph_set,
     (SUBR)tabmorphi, NULL},
    {"tabmorpha", S(TABMORPH), TR, 3, "a", "aaaam", (SUBR)tabmorph_set,
     (SUBR)atabmorphia},
    {"tabmorphak", S(TABMORPH), TR, 3, "a", "akkkm", (SUBR)tabmorph_set,
     (SUBR)atabmorphi}
