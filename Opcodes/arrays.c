...
static OENTRY arrayvars_localops[] =
  {
    ...
    { "##array_set.C", sizeof(ARRAY_SET), 0, "", ":Complex;[]Complex;m", NULL, (SUBR)array_set},
    ...
    { "##array_get.C", sizeof(ARRAY_GET), 0, ":Complex;", ":Complex;[]m", NULL, (SUBR)array_get},
    ...
    {"##add.[i]", sizeof(TABARITH), 0, "i[]", "i[]i[]",
     (SUBR)tabaddi},
    /* complex arithmetic */
    {"##add.Complex[]Complex[]", sizeof(COPS1), 0, ":Complex;[]", ":Complex;[]:Complex;[]",
     (SUBR) cops_init,(SUBR)complexa_plus_complexa},
    {"##mul.Complex[]Complex[]", sizeof(COPS1), 0, ":Complex;[]", ":Complex;[]:Complex;[]",
     (SUBR) cops_init,(SUBR)complexa_x_complexa},
    {"##sub.Complex[]Complex[]", sizeof(COPS1), 0, ":Complex;[]", ":Complex;[]:Complex;[]",
     (SUBR) cops_init,(SUBR)complexa_sub_complexa},
    {"##div.Complex[]Complex[]", sizeof(COPS1), 0, ":Complex;[]", ":Complex;[]:Complex;[]",
    ...
    {"##add.ComplexComplex[]", sizeof(COPS1), 0, ":Complex;[]", ":Complex;:Complex;[]",
     (SUBR) cops_init,(SUBR)complex_plus_complex},
    {"##mul.Complex[]Complex", sizeof(COPS1), 0, ":Complex;[]", ":Complex;[]:Complex;",
     (SUBR) cops_init,(SUBR)complex_x_complex},
    {"##mul.ComplexComplex[]", sizeof(COPS1), 0, ":Complex;[]", ":Complex;:Complex;[]",
     (SUBR) cops_init,(SUBR)complex_x_complex},
     {"##div.Complex[]Complex", sizeof(COPS1), 0, ":Complex;[]", ":Complex;[]:Complex;",
     (SUBR) cops_init,(SUBR)complex_div_complex},   
    {"##sub.Complex[]Complex", sizeof(COPS1), 0, ":Complex;[]", ":Complex;[]:Complex;",
     (SUBR) cops_init,(SUBR)complexa_minus_complex},
    {"##sub.ComplexComplex[]", sizeof(COPS1), 0, ":Complex;[]", ":Complex;:Complex;[]",
