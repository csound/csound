...
public:
  int init(CSOUND *csound) {
    ...
    fluid_synth_program_select(fluidSynth, channel, instrument, bank, preset);
    return OK;
  }
};
...
static OENTRY localops[] = {
    ...
    {(char *)"fluidOut", sizeof(FluidOut), 0, 5, (char *)"aa", (char *)"i",
     (SUBR)&FluidOut::init_, (SUBR)0, (SUBR)&FluidOut::audio_},
    {(char *)"fluidAllOut", sizeof(FluidAllOut), 0, 5, (char *)"aa", (char *)"",
     (SUBR)&FluidAllOut::init_, (SUBR)0, (SUBR)&FluidAllOut::audio_},
