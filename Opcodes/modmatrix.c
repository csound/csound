...
static int32_t modmatrix(CSOUND *csound, MODMATRIX *m) {
...
static OENTRY modmatrix_localops[] = {{"modmatrix", sizeof(MODMATRIX), TB, 3,
                                       "", "iiiiiik", (SUBR)modmatrix_init,
                                       (SUBR)modmatrix, (SUBR)NULL}};
