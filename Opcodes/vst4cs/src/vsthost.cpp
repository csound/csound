...
void VSTPlugin::initializeOpcodes() {
  ...
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effOpen, "effOpen"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effClose, "effClose"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effSetProgram, "effSetProgram"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effGetProgram, "effGetProgram"));
  dispatchOpcodes().insert(std::pair<long, std::string>((long)effSetProgramName,
                                                        "effSetProgramName"));
  dispatchOpcodes().insert(std::pair<long, std::string>((long)effGetProgramName,
                                                        "effGetProgramName"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effGetParamLabel, "effGetParamLabel"));
  dispatchOpcodes().insert(std::pair<long, std::string>(
      (long)effGetParamDisplay, "effGetParamDisplay"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effGetParamName, "effGetParamName"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effGetVu, "effGetVu"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effSetSampleRate, "effSetSampleRate"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effSetBlockSize, "effSetBlockSize"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effMainsChanged, "effMainsChanged"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effEditGetRect, "effEditGetRect"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effEditOpen, "effEditOpen"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effEditClose, "effEditClose"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effEditDraw, "effEditDraw"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effEditMouse, "effEditMouse"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effEditKey, "effEditKey"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effEditIdle, "effEditIdle"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effEditTop, "effEditTop"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effEditSleep, "effEditSleep"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effIdentify, "effIdentify"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effGetChunk, "effGetChunk"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effSetChunk, "effSetChunk"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effProcessEvents, "effProcessEvents"));
  dispatchOpcodes().insert(std::pair<long, std::string>((long)effCanBeAutomated,
                                                        "effCanBeAutomated"));
  dispatchOpcodes().insert(std::pair<long, std::string>(
  ...
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effCopyProgram, "effCopyProgram"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effConnectInput, "effConnectInput"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effConnectOutput, "effConnectOutput"));
  dispatchOpcodes().insert(std::pair<long, std::string>(
  ...
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effOfflineNotify, "effOfflineNotify"));
  dispatchOpcodes().insert(std::pair<long, std::string>((long)effOfflinePrepare,
                                                        "effOfflinePrepare"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effOfflineRun, "effOfflineRun"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effProcessVarIo, "effProcessVarIo"));
  dispatchOpcodes().insert(std::pair<long, std::string>(
      (long)effSetSpeakerArrangement, "effSetSpeakerArrangement"));
  dispatchOpcodes().insert(std::pair<long, std::string>(
      (long)effSetBlockSizeAndSampleRate, "effSetBlockSizeAndSampleRate"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effSetBypass, "effSetBypass"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effGetEffectName, "effGetEffectName"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effGetErrorText, "effGetErrorText"));
  dispatchOpcodes().insert(std::pair<long, std::string>(
  ...
  dispatchOpcodes().insert(std::pair<long, std::string>((long)effVendorSpecific,
                                                        "effVendorSpecific"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effCanDo, "effCanDo"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effGetTailSize, "effGetTailSize"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effIdle, "effIdle"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effGetIcon, "effGetIcon"));
  dispatchOpcodes().insert(std::pair<long, std::string>(
      (long)effSetViewPosition, "effSetViewPosition"));
  dispatchOpcodes().insert(std::pair<long, std::string>(
      (long)effGetParameterProperties, "effGetParameterProperties"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effKeysRequired, "effKeysRequired"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effGetVstVersion, "effGetVstVersion"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effEditKeyDown, "effEditKeyDown"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effEditKeyUp, "effEditKeyUp"));
  dispatchOpcodes().insert(std::pair<long, std::string>(
  ...
  dispatchOpcodes().insert(std::pair<long, std::string>((long)effGetMidiKeyName,
                                                        "effGetMidiKeyName"));
  dispatchOpcodes().insert(std::pair<long, std::string>(
      (long)effBeginSetProgram, "effBeginSetProgram"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effEndSetProgram, "effEndSetProgram"));
  dispatchOpcodes().insert(std::pair<long, std::string>(
      (long)effGetSpeakerArrangement, "effGetSpeakerArrangement"));
  dispatchOpcodes().insert(std::pair<long, std::string>(
      (long)effShellGetNextPlugin, "effShellGetNextPlugin"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effStartProcess, "effStartProcess"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effStopProcess, "effStopProcess"));
  dispatchOpcodes().insert(std::pair<long, std::string>(
      (long)effSetTotalSampleToProcess, "effSetTotalSampleToProcess"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effSetPanLaw, "effSetPanLaw"));
  dispatchOpcodes().insert(
      std::pair<long, std::string>((long)effBeginLoadBank, "effBeginLoadBank"));
  dispatchOpcodes().insert(std::pair<long, std::string>(
      (long)effBeginLoadProgram, "effBeginLoadProgram"));

  masterOpcodes().insert(std::pair<long, std::string>((long)audioMasterAutomate,
                                                      "audioMasterAutomate"));
  masterOpcodes().insert(std::pair<long, std::string>((long)audioMasterVersion,
                                                      "audioMasterVersion"));
  masterOpcodes().insert(std::pair<long, std::string>(
      (long)audioMasterCurrentId, "audioMasterCurrentId"));
  masterOpcodes().insert(
      std::pair<long, std::string>((long)audioMasterIdle, "audioMasterIdle"));
  masterOpcodes().insert(std::pair<long, std::string>(
      (long)audioMasterPinConnected, "audioMasterPinConnected"));
  masterOpcodes().insert(std::pair<long, std::string>((long)audioMasterWantMidi,
                                                      "audioMasterWantMidi"));
  masterOpcodes().insert(std::pair<long, std::string>((long)audioMasterGetTime,
                                                      "audioMasterGetTime"));
  masterOpcodes().insert(std::pair<long, std::string>(
      (long)audioMasterProcessEvents, "audioMasterProcessEvents"));
  masterOpcodes().insert(std::pair<long, std::string>((long)audioMasterSetTime,
                                                      "audioMasterSetTime"));
  masterOpcodes().insert(std::pair<long, std::string>((long)audioMasterTempoAt,
                                                      "audioMasterTempoAt"));
  masterOpcodes().insert(
      std::pair<long, std::string>((long)audioMasterGetNumAutomatableParameters,
                                   "audioMasterGetNumAutomatableParameters"));
  masterOpcodes().insert(
      std::pair<long, std::string>((long)audioMasterGetParameterQuantization,
                                   "audioMasterGetParameterQuantization"));
  masterOpcodes().insert(std::pair<long, std::string>(
      (long)audioMasterIOChanged, "audioMasterIOChanged"));
  masterOpcodes().insert(std::pair<long, std::string>((long)audioMasterNeedIdle,
                                                      "audioMasterNeedIdle"));
  masterOpcodes().insert(std::pair<long, std::string>(
  ...
  masterOpcodes().insert(
      std::pair<long, std::string>((long)audioMasterWillReplaceOrAccumulate,
                                   "audioMasterWillReplaceOrAccumulate"));
  masterOpcodes().insert(
      std::pair<long, std::string>((long)audioMasterGetCurrentProcessLevel,
  ...
  masterOpcodes().insert(
      std::pair<long, std::string>((long)audioMasterOfflineGetCurrentPass,
                                   "audioMasterOfflineGetCurrentPass"));
  masterOpcodes().insert(
      std::pair<long, std::string>((long)audioMasterOfflineGetCurrentMetaPass,
                                   "audioMasterOfflineGetCurrentMetaPass"));
  masterOpcodes().insert(std::pair<long, std::string>(
      (long)audioMasterSetOutputSampleRate, "audioMasterSetOutputSampleRate"));
  ...
  masterOpcodes().insert(
      std::pair<long, std::string>((long)audioMasterGetOutputSpeakerArrangement,
  ...
  masterOpcodes().insert(std::pair<long, std::string>((long)audioMasterSetIcon,
                                                      "audioMasterSetIcon"));
  masterOpcodes().insert(
      std::pair<long, std::string>((long)audioMasterCanDo, "audioMasterCanDo"));
  masterOpcodes().insert(std::pair<long, std::string>(
  ...
  masterOpcodes().insert(std::pair<long, std::string>((long)audioMasterEndEdit,
                                                      "audioMasterEndEdit"));
  masterOpcodes().insert(std::pair<long, std::string>(
  ...
  masterOpcodes().insert(std::pair<long, std::string>((long)audioMasterEditFile,
                                                      "audioMasterEditFile"));
  masterOpcodes().insert(std::pair<long, std::string>(
      (long)audioMasterGetChunkFile, "audioMasterGetChunkFile"));
  masterOpcodes().insert(
      std::pair<long, std::string>((long)audioMasterGetInputSpeakerArrangement,
                                   "audioMasterGetInputSpeakerArrangement"));
}

VSTPlugin::VSTPlugin(CSOUND *csound_)
    : csound(csound_), libraryHandle(0), aeffect(0), hasEditor(false),
      editor(0), window(0), windowHandle(0), pluginIsSynth(true),
      overwrite(false), edited(false), showParameters(false),
      framesPerSecond(0), framesPerBlock(0) {
  memset(&vstTimeInfo, 0, sizeof(VstTimeInfo));
  framesPerSecond = (float)csound->GetSr(csound);
  initializeOpcodes();
}

VSTPlugin::~VSTPlugin() { Free(); }
...
int VSTPlugin::Instantiate(const char *libraryName_) {
...
#ifdef __MACH__
  CFStringRef vstBundlePath = CFStringCreateWithCString(
      kCFAllocatorDefault, libraryName_, kCFStringEncodingMacRoman);
  CFURLRef vstBundleURL = CFURLCreateWithFileSystemPath(
      kCFAllocatorDefault, vstBundlePath, kCFURLPOSIXPathStyle, true);
  ...
  PVSTMAIN main = (PVSTMAIN)CFBundleGetFunctionPointerForName(
      vstBundle, CFSTR("VSTPluginMain"));
  /* For VST SDK 2.3 and earlier. */
  if (!main) {
    main = (PVSTMAIN)CFBundleGetFunctionPointerForName(vstBundle,
                                                       CFSTR("main_macho"));
  }
#else
  /* For VST SDK 2.4 and later. */
  PVSTMAIN main =
      (PVSTMAIN)csound->GetLibrarySymbol(libraryHandle, "VSTPluginMain");
  if (!main) {
    /* For VST SDK 2.3 and earlier. */
...
void VSTPlugin::Info() {
  ...
  Log("====================================================\n");
  Log("Loaded plugin: %s\n", productName);
  if (!aeffect->dispatcher(aeffect, effGetVendorString, 0, 0, &vendorName,
                           0.0f)) {
...
void VSTPlugin::Init() {
  ...
  // Dispatch(effSetBlockSizeAndSampleRate, 0, framesPerBlock, NULL, (float)
  // framesPerSecond);
}
...
bool VSTPlugin::replace() { return overwrite; }
...
void VSTPlugin::SetShowParameters(bool s) { showParameters = s; }

bool VSTPlugin::ShowParams() { return showParameters; }
...
void VSTPlugin::StopEditing() { edited = false; }
...
int VSTPlugin::GetNumParams(void) { return aeffect->numParams; }
...
unsigned long VSTPlugin::GetVersion(void) { return pluginVersion; }

char *VSTPlugin::GetVendorName(void) { return vendorName; }

char *VSTPlugin::GetDllName(void) { return libraryName; }

long VSTPlugin::NumParameters(void) { return aeffect->numParams; }

float VSTPlugin::GetParameter(long parameter) {
  return aeffect->getParameter(aeffect, parameter);
}

int VSTPlugin::NumPrograms(void) { return aeffect->numPrograms; }
...
VstTimeInfo *VSTPlugin::GetTime(void) {
  ...
  Debug("&vstTimeInfo 0x%x sampleRate %f samplePos %f.\n", &vstTimeInfo,
        vstTimeInfo.sampleRate, vstTimeInfo.samplePos);
  return &vstTimeInfo;
}

bool VSTPlugin::IsSynth() { return pluginIsSynth; }

bool VSTPlugin::OnCanDo(const char *ptr) {
  // printf("Can do call: %s.\n", ptr);
  if ((!strcmp(ptr, "sendVstMidiEvent")) ||
      (!strcmp(ptr, "receiveVstMidiEvent")) ||
      (!strcmp(ptr, "sendVstEvents")) || (!strcmp(ptr, "receiveVstEvents")) ||
...
bool VSTPlugin::OnInputConnected(AEffect *effect, long input) { return true; }

bool VSTPlugin::OnOutputConnected(AEffect *effect, long output) { return true; }

VstIntPtr VSTPlugin::Master(AEffect *effect, VstInt32 opcode, VstInt32 index,
  ...
  //   else {
  //     fprintf(stdout, "VSTPlugin::Master(AEffect 0x%p, opcode %ld %s, index
  //     %ld, "
