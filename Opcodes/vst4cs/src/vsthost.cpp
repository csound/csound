...
void VSTPlugin::initializeOpcodes()
{
    ...
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effSetProgramName, "effSetProgramName"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effGetProgramName, "effGetProgramName"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effGetParamLabel, "effGetParamLabel"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effGetParamDisplay, "effGetParamDisplay"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effGetParamName, "effGetParamName"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effGetVu, "effGetVu"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effSetSampleRate, "effSetSampleRate"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effSetBlockSize, "effSetBlockSize"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effMainsChanged, "effMainsChanged"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effEditGetRect, "effEditGetRect"));
    dispatchOpcodes().insert(std::pair<long,
    ...
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effCopyProgram, "effCopyProgram"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effConnectInput, "effConnectInput"));
    dispatchOpcodes().insert(std::pair<long,
    ...
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effOfflinePrepare,
                                          "effOfflinePrepare"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effOfflineRun, "effOfflineRun"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effProcessVarIo, "effProcessVarIo"));
    dispatchOpcodes().insert(std::pair<long,
    ...
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effSetBypass, "effSetBypass"));
    dispatchOpcodes().insert(std::pair<long,
    ...
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effVendorSpecific,
                                          "effVendorSpecific"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effCanDo, "effCanDo"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effGetTailSize, "effGetTailSize"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effIdle, "effIdle"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effGetIcon, "effGetIcon"));
    dispatchOpcodes().insert(std::pair<long,
    ...
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effStartProcess,
                                          "effStartProcess"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effStopProcess, "effStopProcess"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effSetTotalSampleToProcess,
                                          "effSetTotalSampleToProcess"));
    dispatchOpcodes().insert(std::pair<long,
                             std::string>((long) effSetPanLaw, "effSetPanLaw"));
    dispatchOpcodes().insert(std::pair<long,
    ...
    masterOpcodes().insert(std::pair<long,
                           std::string>((long) audioMasterIdle, "audioMasterIdle"));
    masterOpcodes().insert(std::pair<long,
    ...
    masterOpcodes().insert(std::pair<long,
                           std::string>((long) audioMasterSetIcon,
                                        "audioMasterSetIcon"));
    masterOpcodes().insert(std::pair<long,
                           std::string>((long) audioMasterCanDo, "audioMasterCanDo"));
    masterOpcodes().insert(std::pair<long,
...
int VSTPlugin::Instantiate(const char *libraryName_)
{
    ...
    if (!main) {
      /* For VST SDK 2.3 and earlier. */
      main = (PVSTMAIN) csound->GetLibrarySymbol(libraryHandle,
                                                 "main");
    }
#endif
    if (!main) {
