...
static int32_t svf(CSOUND *csound, SVF *p) {
  MYFLT f1 = FL(0.0), q1 = FL(1.0), scale = FL(1.0), lfco = -FL(1.0),
        lq = -FL(1.0);
...
static OENTRY localops[] = {
    ...
    {"phaser2", S(PHASER2), 0, 3, "a", "akkkkkko", (SUBR)phaser2set,
     (SUBR)phaser2},
    {"phaser1", S(PHASER1), 0, 3, "a", "akkko", (SUBR)phaser1set,
     (SUBR)phaser1}};
