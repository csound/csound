 ...
 *  - Added curves: lemniskate (G), limacon with parameter, cornoid with
 * parameter, trisec (Ceva) with parameter, scarabeus with 2 parameters, folium
 * with parameter
 *  - tables are krate
...
static void ellipse(MYFLT t, MYFLT kx, MYFLT ky, MYFLT krx, MYFLT kry,
                    MYFLT kparam, MYFLT *outX, MYFLT *outY) {
...
static void limacon(MYFLT t, MYFLT kx, MYFLT ky, MYFLT krx, MYFLT kry,
                    MYFLT kparam, MYFLT *outX, MYFLT *outY) {
...
static void lemniskateG(MYFLT t, MYFLT kx, MYFLT ky, MYFLT krx, MYFLT kry,
                        MYFLT kparam, MYFLT *outX, MYFLT *outY) {
  double x = t + kparam * SIN(t);
  *outX = kx + krx * COS(x);
...
*/
static void cornoid(MYFLT t, MYFLT kx, MYFLT ky, MYFLT krx, MYFLT kry,
                    MYFLT kparam, MYFLT *outX, MYFLT *outY) {
...
*/
static void trisec(MYFLT t, MYFLT kx, MYFLT ky, MYFLT krx, MYFLT kry,
                   MYFLT kparam, MYFLT *outX, MYFLT *outY) {
...
static void scarabeus(MYFLT t, MYFLT kx, MYFLT ky, MYFLT krx, MYFLT kry,
                      MYFLT kparam, MYFLT *outX, MYFLT *outY) {
...
static void folium(MYFLT t, MYFLT kx, MYFLT ky, MYFLT krx, MYFLT kry,
                   MYFLT kparam, MYFLT *outX, MYFLT *outY) {
  double sint = SIN(t);
  double cost = COS(t);
...
static void talbot(MYFLT t, MYFLT kx, MYFLT ky, MYFLT krx, MYFLT kry,
                   MYFLT kparam, MYFLT *outX, MYFLT *outY) {
  double sint = SIN(t);
  double cost = COS(t);
...
static void (*ifuncs[8])(MYFLT, MYFLT, MYFLT, MYFLT, MYFLT, MYFLT, MYFLT *,
                         MYFLT *) = {ellipse, lemniskateG, limacon, cornoid,
                                     trisec,  scarabeus,   folium,  talbot};
...
static int32_t wtPerf(CSOUND *csound, WAVETER *p) {
  ...
  for (i = offset; i < nsmps; i++) {
    ...
    ifuncs[kfunc](theta, *p->kx, *p->ky, *p->krx, *p->kry, *p->kparam, &xc,
                  &yc);
...
static OENTRY wter_localops[] = {
    {"wterrain2", S(WAVETER), TR, 3, "a", "kkkkkkkkkkk", (SUBR)wtinit,
     (SUBR)wtPerf},
};
...
int32_t wter2_init_(CSOUND *csound) {
  return csound->AppendOpcodes(
      csound, &(wter_localops[0]),
      (int32_t)(sizeof(wter_localops) / sizeof(OENTRY)));
}
